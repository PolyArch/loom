...
TMP="$(mktemp -d -t cmsis-dsp-dfg-per-row-gate.XXXXXX)"
trap 'rm -rf "${TMP}"' EXIT
...
BasicMathFunctions/arm_abs_f32.c|thumbv7em-none-eabi|cortex-m4|thumbv7em-unknown-none-eabi|arm_abs_f32||99|1|1|1|1
T
