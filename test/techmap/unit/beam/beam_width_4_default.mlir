...
fabric.module @fu_am(%cast0_fu_am : !fabric.bits<32>, %cast1_fu_am : !fabric.bits<32>) {
  fabric.pe [spatial] (%a = %cast0_fu_am : !fabric.bits<32>, %b = %cast1_fu_am : !fabric.bits<32>) -> !fabric.bits<32> {
  %r = fabric.fu(%x = %a : !fabric.bits<32>, %y = %b : !fabric.bits<32>)
                -> !fabric.bits<32> {
    %k = fabric.op [@arith.addi] (%x, %y)
         : (!fabric.bits<32>, !fabric.bits<32>) -> !fabric.bits<32>
...
fabric.module @fu_amam(%cast0_fu_amam : !fabric.bits<32>, %cast1_fu_amam : !fabric.bits<32>) {
  fabric.pe [spatial] (%a = %cast0_fu_amam : !fabric.bits<32>, %b = %cast1_fu_amam : !fabric.bits<32>) -> !fabric.bits<32> {
  %r = fabric.fu(%x = %a : !fabric.bits<32>, %y = %b : !fabric.bits<32>)
                -> !fabric.bits<32> {
