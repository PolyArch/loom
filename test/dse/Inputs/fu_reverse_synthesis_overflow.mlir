module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<index, 64>>} {
  dataflow.graph private @checked_add(%start: none, %lhs: i32, %rhs: i32)
      -> i32 attributes {input_segments = array<i32: 2, 0, 0>,
                         result_segments = array<i32: 1, 0, 0>} {
    %value = arith.addi %lhs, %rhs overflow<nsw> : i32
  ...
  dataflow.thread private @worker domain(#dataflow.thread_domain<dense>)(
    ...
    %value, %done = dataflow.graph.launch @checked_add deps(%ctrl)
