...
// CSV-I32-PASS-NEXT: stream_add_slt,stream_add_i32_adg,stream_add_slt__stream_add_slt__stream_add_i32_adg,1,0,0,0,pass
...
// CSV-I64-PASS-NEXT: stream_add_slt_i64,stream_add_i64_adg,stream_add_slt_i64__stream_add_slt_i64__stream_add_i64_adg,1,0,0,0,pass
...
// CSV-I64-ON-I32-NEXT: stream_i64_on_i32,stream_add_i32_adg,stream_i64_on_i32__stream_add_slt_i64__stream_add_i32_adg,0,0,0,1,fail,missing hardware resource for software op dataflow.stream
...
// CSV-I32-ON-I64-NEXT: stream_i32_on_i64,stream_add_i64_adg,stream_i32_on_i64__stream_add_slt__stream_add_i64_adg,0,0,0,1,fail,missing hardware resource for software op dataflow.stream
...
// CSV-CONFIG-FAIL-NEXT: stream_sdiv_sgt,stream_add_i32_adg,stream_sdiv_sgt__stream_sdiv_sgt__stream_add_i32_adg,0,0,0,1,fail,missing hardware resource for software op dataflow.stream
...
module {
  ...
  fabric.module @stream_add_i32_adg(%init: !fabric.bits<32>,
  ...
  fabric.module @stream_add_i64_adg(%init: !fabric.bits<64>,
    ...
    fabric.pe [spatial] (%pa = %init : !fabric.bits<64>,
      ...
      fabric.fu(%fa = %pa : !fabric.bits<64>,
                ...
                %fc = %pc : !fabric.bits<64>) -> !fabric.bits<64> {
        %iv, %phase = fabric.op [@dataflow.stream] (%fa, %fb, %fc)
            {hw_params = [{step_kind = 0 : i32,
                           predicate = [2 : i64, 4 : i64]}]}
