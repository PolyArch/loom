// RUN: loom-pnr-map --dfg-mlir %s --graph ctlz_map --hardware-mlir %S/shared_reduction_adg.mlir --hardware shared_reduction_adg --workload ctlz_map --output %t.mapping.csv --artifact %t.mapping.json
