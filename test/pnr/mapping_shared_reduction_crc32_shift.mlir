// RUN: loom-pnr-map --dfg-mlir %s --graph crc32_shift_mix --hardware-mlir %S/shared_reduction_adg.mlir --hardware shared_reduction_adg --workload crc32_shift_mix --output %t.mapping.csv --artifact %t.mapping.json
