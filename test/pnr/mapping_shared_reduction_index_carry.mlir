// RUN: loom-pnr-map --dfg-mlir %s --graph shared_index_carry --hardware-mlir %S/shared_reduction_adg.mlir --hardware shared_reduction_adg --workload shared_index_carry --output %t.mapping.csv --artifact %t.mapping.json
...
// JSON-DAG: "config_records": 304
// JSON-DAG: "edge_ref": "arith.addi#0.result0->dataflow.carry#1.operand2"
// JSON-DAG: "source_endpoint": "shared_reduction_adg::fabric.op#17.result0"
// JSON-DAG: "sink_endpoint": "shared_reduction_adg::fabric.op#15.operand2"
// JSON-DAG: "edge_ref": "dataflow.carry#1.result0->arith.addi#0.operand0"
// JSON-DAG: "source_endpoint": "shared_reduction_adg::fabric.op#15.result0"
// JSON-DAG: "sink_endpoint": "shared_reduction_adg::fabric.op#17.operand0"
...
// JSON-DAG: "source_endpoint": "shared_reduction_adg::fabric.op#19.result0"
// JSON-DAG: "sink_endpoint": "shared_reduction_adg::fabric.op#15.operand1"
