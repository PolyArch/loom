// RUN: loom-pnr-map --dfg-mlir %s --graph bisection_step --hardware-mlir %S/shared_memory_reduction_adg.mlir --hardware shared_memory_reduction_adg --workload bisection_step --output %t.mapping.csv --artifact %t.mapping.json
