...
// CSV-NEXT: vecsum,shared_reduction_adg,vecsum__g_t_vecsum_red_0_0__shared_reduction_adg,5,0,6,0,fail,unrouted software edges lack Fabric ADG connectivity
...
// JSON-DAG: "unrouted_edges": 6
// JSON-DAG: "unplaced_records": 0
// JSON-DAG: "config_records": 0
// JSON-DAG: "routes": []
