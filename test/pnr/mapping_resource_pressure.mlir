...
// CSV-NEXT: two_loads_one_port,one_load_adg,two_loads_one_port__two_loads_one_port__one_load_adg,2,0,{{[0-9]+}},1,fail,missing hardware resource for software op dataflow.load
...
// MIXED-CSV-NEXT: mixed_addi_pressure,mixed_addi_adg,mixed_addi_pressure__mixed_addi_pressure__mixed_addi_adg,2,0,{{[0-9]+}},1,fail,missing hardware resource for software op arith.addi
...
module {
  ...
  fabric.module @mixed_addi_adg(%i32a : !fabric.bits<32>,
                                %i32b : !fabric.bits<32>,
                                %i64a : !fabric.bits<64>,
                                %i64b : !fabric.bits<64>) {
