// RUN: loom-pnr-map --dfg-mlir %s --graph long_add_chain --hardware-mlir %s --hardware long_chain_adg --workload long_add_chain --output %t.mapping.csv --artifact %t.mapping.json
