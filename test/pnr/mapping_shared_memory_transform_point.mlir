// RUN: loom-pnr-map --dfg-mlir %s --graph transform_point --hardware-mlir %S/shared_memory_reduction_adg.mlir --hardware shared_memory_reduction_adg --workload transform_point --output %t.mapping.csv --artifact %t.mapping.json
