...
fabric.module @shared_memory_reduction_adg(%mgr : memref<?x!fabric.bits<32>>,
  ...
  %wide_route_bridge1 = fabric.fifo %wide_route_bridge1_input [max_depth = 1, bypassable = true] {bypassed = true}
    : !fabric.bits<32> to !fabric.bits<64>
  %wide_mul0_lhs, %wide_mul0_rhs, %wide_mul1_lhs, %wide_mul1_rhs, %wide_udiv0_lhs, %wide_udiv0_rhs, %wide_udiv1_lhs, %wide_udiv1_rhs, %wide_shift0_lhs, %wide_shift0_rhs, %wide_cmp0_lhs, %wide_cmp0_rhs, %wide_mux0_pred, %wide_mux0_false, %wide_mux0_true, %wide_trunc0_input, %wide_trunc1_input, %wide_trunc2_input, %wide_trunc3_input, %wide_index_cast0_input, %wide_index_cast1_input, %wide_index_cast2_input, %wide_index_cast3_input, %wide_index_castui0_input, %wide_index_castui1_input =
      fabric.switch [spatial] %wide_const0, %wide_const1, %wide_mul0, %wide_mul1, %wide_udiv0, %wide_udiv1, %wide_shift0, %wide_mux0, %wide_zext0, %wide_zext1, %wide_zext2, %wide_zext3, %wide_sext0, %wide_sext1, %wide_sext2, %wide_sext3, %wide_route_bridge0, %wide_route_bridge1
        [{connectivity_table = ["111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111", "111111111111111111"]}]
        ...
        -> (!fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>, !fabric.bits<64>)
