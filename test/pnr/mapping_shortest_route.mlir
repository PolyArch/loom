// RUN: loom-pnr-map --dfg-mlir %s --graph shortest_route --hardware-mlir %s --hardware shortest_route_adg --workload shortest_route --output %t.mapping.csv --artifact %t.mapping.json
...
module {
  dataflow.graph.func private @shortest_route(%ctrl: none, %lhs: i32, %rhs: i32)
      -> (none, i32) {
