// RUN: loom-pnr-map --dfg-mlir %s --graph spmm_computed_address --hardware-mlir %S/shared_memory_reduction_adg.mlir --hardware shared_memory_reduction_adg --workload spmm_computed_address --output %t.csv --artifact %t.json
