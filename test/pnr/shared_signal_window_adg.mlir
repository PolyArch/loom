...
// CHECK-DAG: const_hex_value = ["0x00000000", "0x00000001", "0x00000002", "0x00000003", "0x00000004", "0x00000008", "0x00000010", "0xffffffff", "0x3f800000", "0x40000000", "0xbf800000", "0x322bcc77", "0x3727c5ac", "0x3e22f983", "0x44000000", "0xc4000000", "0x000001ff"]
// CHECK-DAG: const_hex_value = ["0x0000000000000000", "0x0000000000000001", "0x0000000000000002", "0x0000000000000003", "0x0000000000000004", "0x0000000000000008", "0x0000000000000010"]
// CHECK-DAG: fabric.op [@arith.addf, @arith.subf]
// CHECK-DAG: fabric.op [@llvm.intr.usub.sat]
// CHECK-DAG: fabric.op [@llvm.fneg]
// CHECK-DAG: fabric.op [@llvm.intr.fabs]
// CHECK-DAG: fabric.op [@math.sqrt]
// CHECK-DAG: fabric.op [@llvm.sitofp]
// CHECK-DAG: fabric.op [@llvm.fptosi]
...
fabric.module @shared_signal_window_adg(%mgr : memref<?x!fabric.bits<32>>,
      ...
      fabric.pe [spatial] (%pa = %const0_ctrl : !fabric.bits<0> to !fabric.bits<32>)
        ...
        fabric.fu(%token = %pa : !fabric.bits<32> to !fabric.bits<0>) -> !fabric.bits<32> {
          %value = fabric.op [@dataflow.constant] (%token)
              {hw_params = [{const_hex_value = ["0x00000000", "0x00000001", "0x00000002", "0x00000003", "0x00000004", "0x00000008", "0x00000010", "0xffffffff", "0x3f800000", "0x40000000", "0xbf800000", "0x322bcc77", "0x3727c5ac", "0x3e22f983", "0x44000000", "0xc4000000", "0x000001ff"]}]}
  ...
  %wide_const0 =
      fabric.pe [spatial] (%pa = %wide_const0_ctrl : !fabric.bits<0> to !fabric.bits<64>)
        ...
        fabric.fu(%token = %pa : !fabric.bits<64> to !fabric.bits<0>) -> !fabric.bits<64> {
          %value = fabric.op [@dataflow.constant] (%token)
              {hw_params = [{const_hex_value = ["0x0000000000000000", "0x0000000000000001", "0x0000000000000002", "0x0000000000000003", "0x0000000000000004", "0x0000000000000008", "0x0000000000000010"]}]}
  ...
  %wide_const2 =
      fabric.pe [spatial] (%pa = %wide_const2_ctrl : !fabric.bits<0> to !fabric.bits<64>)
          -> !fabric.bits<64> {
        fabric.fu(%token = %pa : !fabric.bits<64> to !fabric.bits<0>) -> !fabric.bits<64> {
          %value = fabric.op [@dataflow.constant] (%token)
              {hw_params = [{const_hex_value = ["0x0000000000000000", "0x0000000000000001", "0x0000000000000002", "0x0000000000000003", "0x0000000000000004", "0x0000000000000008", "0x0000000000000010"]}]}
  ...
  %fabs0 =
      fabric.pe [spatial] (%value = %fabs0_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.intr.fabs] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
          fabric.yield %result : !fabric.bits<32>
        }
      }
  %fabs1 =
      fabric.pe [spatial] (%value = %fabs1_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.intr.fabs] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
  ...
  %sitofp0 =
      fabric.pe [spatial] (%value = %sitofp0_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.sitofp] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
          fabric.yield %result : !fabric.bits<32>
        }
      }
  %sitofp1 =
      fabric.pe [spatial] (%value = %sitofp1_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.sitofp] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
  ...
  %fptosi0 =
      fabric.pe [spatial] (%value = %fptosi0_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.fptosi] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
          fabric.yield %result : !fabric.bits<32>
        }
      }
  %fptosi1 =
      fabric.pe [spatial] (%value = %fptosi1_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.fptosi] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
  ...
  %fptoui0 =
      fabric.pe [spatial] (%value = %fptoui0_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.fptoui] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
          fabric.yield %result : !fabric.bits<32>
        }
      }
  %fptoui1 =
      fabric.pe [spatial] (%value = %fptoui1_input : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%input = %value : !fabric.bits<32>) -> !fabric.bits<32> {
          %result = fabric.op [@llvm.fptoui] (%input)
                   : (!fabric.bits<32>) -> !fabric.bits<32>
  ...
  %usub_sat0 =
      fabric.pe [spatial] (%lhs = %usub_sat0_lhs : !fabric.bits<32>,
                           %rhs = %usub_sat0_rhs : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%a = %lhs : !fabric.bits<32>,
                  %b = %rhs : !fabric.bits<32>) -> !fabric.bits<32> {
          %value = fabric.op [@llvm.intr.usub.sat] (%a, %b)
              : (!fabric.bits<32>, !fabric.bits<32>) -> !fabric.bits<32>
          fabric.yield %value : !fabric.bits<32>
        }
      }
  %usub_sat1 =
      fabric.pe [spatial] (%lhs = %usub_sat1_lhs : !fabric.bits<32>,
                           %rhs = %usub_sat1_rhs : !fabric.bits<32>)
          -> !fabric.bits<32> {
        fabric.fu(%a = %lhs : !fabric.bits<32>,
                  %b = %rhs : !fabric.bits<32>) -> !fabric.bits<32> {
          %value = fabric.op [@llvm.intr.usub.sat] (%a, %b)
  ...
  %stream0_lb, %stream0_ub, %stream0_step, %stream1_lb, %stream1_ub, %stream1_step, %stream2_lb, %stream2_ub, %stream2_step, %stream3_lb, %stream3_ub, %stream3_step, %carry0_cond, %carry0_init, %carry0_next, %carry1_cond, %carry1_init, %carry1_next, %carry2_cond, %carry2_init, %carry2_next, %carry3_cond, %carry3_init, %carry3_next, %carry4_cond, %carry4_init, %carry4_next, %carry5_cond, %carry5_init, %carry5_next, %carry6_cond, %carry6_init, %carry6_next, %carry7_cond, %carry7_init, %carry7_next, %carry8_cond, %carry8_init, %carry8_next, %carry9_cond, %carry9_init, %carry9_next, %carry10_cond, %carry10_init, %carry10_next, %carry11_cond, %carry11_init, %carry11_next, %carry12_cond, %carry12_init, %carry12_next, %carry13_cond, %carry13_init, %carry13_next, %carry14_cond, %carry14_init, %carry14_next, %carry15_cond, %carry15_init, %carry15_next, %carry16_cond, %carry16_init, %carry16_next, %carry17_cond, %carry17_init, %carry17_next, %carry18_cond, %carry18_init, %carry18_next, %carry19_cond, %carry19_init, %carry19_next, %carry20_cond, %carry20_init, %carry20_next, %carry21_cond, %carry21_init, %carry21_next, %carry22_cond, %carry22_init, %carry22_next, %carry23_cond, %carry23_init, %carry23_next, %carry24_cond, %carry24_init, %carry24_next, %carry25_cond, %carry25_init, %carry25_next, %carry26_cond, %carry26_init, %carry26_next, %carry27_cond, %carry27_init, %carry27_next, %gate0_cond_in, %gate0_value_in, %gate1_cond_in, %gate1_value_in, %gate2_cond_in, %gate2_value_in, %gate3_cond_in, %gate3_value_in, %gate4_cond_in, %gate4_value_in, %gate5_cond_in, %gate5_value_in, %gate6_cond_in, %gate6_value_in, %gate7_cond_in, %gate7_value_in, %gate8_cond_in, %gate8_value_in, %gate9_cond_in, %gate9_value_in, %gate10_cond_in, %gate10_value_in, %gate11_cond_in, %gate11_value_in, %gate12_cond_in, %gate12_value_in, %gate13_cond_in, %gate13_value_in, %gate14_cond_in, %gate14_value_in, %gate15_cond_in, %gate15_value_in, %gate16_cond_in, %gate16_value_in, %gate17_cond_in, %gate17_value_in, %gate18_cond_in, %gate18_value_in, %gate19_cond_in, %gate19_value_in, %gate20_cond_in, %gate20_value_in, %gate21_cond_in, %gate21_value_in, %gate22_cond_in, %gate22_value_in, %gate23_cond_in, %gate23_value_in, %gate24_cond_in, %gate24_value_in, %gate25_cond_in, %gate25_value_in, %gate26_cond_in, %gate26_value_in, %gate27_cond_in, %gate27_value_in, %invariant0_cond, %invariant0_value, %invariant1_cond, %invariant1_value, %invariant2_cond, %invariant2_value, %invariant3_cond, %invariant3_value, %invariant4_cond, %invariant4_value, %invariant5_cond, %invariant5_value, %invariant6_cond, %invariant6_value, %invariant7_cond, %invariant7_value, %invariant8_cond, %invariant8_value, %invariant9_cond, %invariant9_value, %invariant10_cond, %invariant10_value, %invariant11_cond, %invariant11_value, %add0_lhs, %add0_rhs, %add1_lhs, %add1_rhs, %add2_lhs, %add2_rhs, %add3_lhs, %add3_rhs, %add4_lhs, %add4_rhs, %add5_lhs, %add5_rhs, %add6_lhs, %add6_rhs, %add7_lhs, %add7_rhs, %add8_lhs, %add8_rhs, %add9_lhs, %add9_rhs, %add10_lhs, %add10_rhs, %add11_lhs, %add11_rhs, %add12_lhs, %add12_rhs, %add13_lhs, %add13_rhs, %add14_lhs, %add14_rhs, %add15_lhs, %add15_rhs, %add16_lhs, %add16_rhs, %add17_lhs, %add17_rhs, %add18_lhs, %add18_rhs, %add19_lhs, %add19_rhs, %add20_lhs, %add20_rhs, %add21_lhs, %add21_rhs, %add22_lhs, %add22_rhs, %add23_lhs, %add23_rhs, %add24_lhs, %add24_rhs, %add25_lhs, %add25_rhs, %add26_lhs, %add26_rhs, %add27_lhs, %add27_rhs, %add28_lhs, %add28_rhs, %add29_lhs, %add29_rhs, %add30_lhs, %add30_rhs, %add31_lhs, %add31_rhs, %mul0_lhs, %mul0_rhs, %mul1_lhs, %mul1_rhs, %mul2_lhs, %mul2_rhs, %mul3_lhs, %mul3_rhs, %mul4_lhs, %mul4_rhs, %mul5_lhs, %mul5_rhs, %mul6_lhs, %mul6_rhs, %mul7_lhs, %mul7_rhs, %mul8_lhs, %mul8_rhs, %mul9_lhs, %mul9_rhs, %mul10_lhs, %mul10_rhs, %mul11_lhs, %mul11_rhs, %mul12_lhs, %mul12_rhs, %mul13_lhs, %mul13_rhs, %mul14_lhs, %mul14_rhs, %mul15_lhs, %mul15_rhs, %div0_lhs, %div0_rhs, %div1_lhs, %div1_rhs, %div2_lhs, %div2_rhs, %div3_lhs, %div3_rhs, %fp_add0_lhs, %fp_add0_rhs, %fp_add1_lhs, %fp_add1_rhs, %fp_add2_lhs, %fp_add2_rhs, %fp_add3_lhs, %fp_add3_rhs, %fp_add4_lhs, %fp_add4_rhs, %fp_add5_lhs, %fp_add5_rhs, %fp_add6_lhs, %fp_add6_rhs, %fp_add7_lhs, %fp_add7_rhs, %fp_add8_lhs, %fp_add8_rhs, %fp_add9_lhs, %fp_add9_rhs, %fp_add10_lhs, %fp_add10_rhs, %fp_add11_lhs, %fp_add11_rhs, %fp_add12_lhs, %fp_add12_rhs, %fp_add13_lhs, %fp_add13_rhs, %fp_add14_lhs, %fp_add14_rhs, %fp_add15_lhs, %fp_add15_rhs, %fp_add16_lhs, %fp_add16_rhs, %fp_add17_lhs, %fp_add17_rhs, %fp_add18_lhs, %fp_add18_rhs, %fp_add19_lhs, %fp_add19_rhs, %fp_add20_lhs, %fp_add20_rhs, %fp_add21_lhs, %fp_add21_rhs, %fp_add22_lhs, %fp_add22_rhs, %fp_add23_lhs, %fp_add23_rhs, %fp_add24_lhs, %fp_add24_rhs, %fp_add25_lhs, %fp_add25_rhs, %fp_add26_lhs, %fp_add26_rhs, %fp_add27_lhs, %fp_add27_rhs, %fp_add28_lhs, %fp_add28_rhs, %fp_add29_lhs, %fp_add29_rhs, %fp_add30_lhs, %fp_add30_rhs, %fp_add31_lhs, %fp_add31_rhs, %fp_add32_lhs, %fp_add32_rhs, %fp_add33_lhs, %fp_add33_rhs, %fp_add34_lhs, %fp_add34_rhs, %fp_add35_lhs, %fp_add35_rhs, %fp_add36_lhs, %fp_add36_rhs, %fp_add37_lhs, %fp_add37_rhs, %fp_add38_lhs, %fp_add38_rhs, %fp_add39_lhs, %fp_add39_rhs, %fp_add40_lhs, %fp_add40_rhs, %fp_add41_lhs, %fp_add41_rhs, %fp_add42_lhs, %fp_add42_rhs, %fp_add43_lhs, %fp_add43_rhs, %fp_add44_lhs, %fp_add44_rhs, %fp_add45_lhs, %fp_add45_rhs, %fp_add46_lhs, %fp_add46_rhs, %fp_add47_lhs, %fp_add47_rhs, %fp_add48_lhs, %fp_add48_rhs, %fp_add49_lhs, %fp_add49_rhs, %fp_add50_lhs, %fp_add50_rhs, %fp_add51_lhs, %fp_add51_rhs, %fp_add52_lhs, %fp_add52_rhs, %fp_add53_lhs, %fp_add53_rhs, %fp_add54_lhs, %fp_add54_rhs, %fp_add55_lhs, %fp_add55_rhs, %fp_add56_lhs, %fp_add56_rhs, %fp_add57_lhs, %fp_add57_rhs, %fp_add58_lhs, %fp_add58_rhs, %fp_add59_lhs, %fp_add59_rhs, %fp_add60_lhs, %fp_add60_rhs, %fp_add61_lhs, %fp_add61_rhs, %fp_add62_lhs, %fp_add62_rhs, %fp_add63_lhs, %fp_add63_rhs, %fp_add64_lhs, %fp_add64_rhs, %fp_add65_lhs, %fp_add65_rhs, %fp_add66_lhs, %fp_add66_rhs, %fp_add67_lhs, %fp_add67_rhs, %fp_add68_lhs, %fp_add68_rhs, %fp_add69_lhs, %fp_add69_rhs, %fp_add70_lhs, %fp_add70_rhs, %fp_add71_lhs, %fp_add71_rhs, %fp_mul0_lhs, %fp_mul0_rhs, %fp_mul1_lhs, %fp_mul1_rhs, %fp_mul2_lhs, %fp_mul2_rhs, %fp_mul3_lhs, %fp_mul3_rhs, %fp_mul4_lhs, %fp_mul4_rhs, %fp_mul5_lhs, %fp_mul5_rhs, %fp_mul6_lhs, %fp_mul6_rhs, %fp_mul7_lhs, %fp_mul7_rhs, %fp_mul8_lhs, %fp_mul8_rhs, %fp_mul9_lhs, %fp_mul9_rhs, %fp_mul10_lhs, %fp_mul10_rhs, %fp_mul11_lhs, %fp_mul11_rhs, %fp_mul12_lhs, %fp_mul12_rhs, %fp_mul13_lhs, %fp_mul13_rhs, %fp_mul14_lhs, %fp_mul14_rhs, %fp_mul15_lhs, %fp_mul15_rhs, %fp_mul16_lhs, %fp_mul16_rhs, %fp_mul17_lhs, %fp_mul17_rhs, %fp_mul18_lhs, %fp_mul18_rhs, %fp_mul19_lhs, %fp_mul19_rhs, %fp_mul20_lhs, %fp_mul20_rhs, %fp_mul21_lhs, %fp_mul21_rhs, %fp_mul22_lhs, %fp_mul22_rhs, %fp_mul23_lhs, %fp_mul23_rhs, %fp_div0_lhs, %fp_div0_rhs, %fp_div1_lhs, %fp_div1_rhs, %fp_div2_lhs, %fp_div2_rhs, %fp_div3_lhs, %fp_div3_rhs, %fneg0_input, %fneg1_input, %fneg2_input, %fneg3_input, %fabs0_input, %fabs1_input, %sqrt0_input, %sqrt1_input, %exp0_input, %exp1_input, %exp2_input, %exp3_input, %cos0_input, %cos1_input, %cos2_input, %cos3_input, %sitofp0_input, %sitofp1_input, %uitofp0_input, %uitofp1_input, %uitofp2_input, %uitofp3_input, %fptosi0_input, %fptosi1_input, %fptoui0_input, %fptoui1_input, %fma0_lhs, %fma0_rhs, %fma0_acc, %fma1_lhs, %fma1_rhs, %fma1_acc, %fma2_lhs, %fma2_rhs, %fma2_acc, %fma3_lhs, %fma3_rhs, %fma3_acc, %fma4_lhs, %fma4_rhs, %fma4_acc, %fma5_lhs, %fma5_rhs, %fma5_acc, %fma6_lhs, %fma6_rhs, %fma6_acc, %fma7_lhs, %fma7_rhs, %fma7_acc, %and0_lhs, %and0_rhs, %and1_lhs, %and1_rhs, %and2_lhs, %and2_rhs, %and3_lhs, %and3_rhs, %and4_lhs, %and4_rhs, %and5_lhs, %and5_rhs, %and6_lhs, %and6_rhs, %and7_lhs, %and7_rhs, %and8_lhs, %and8_rhs, %and9_lhs, %and9_rhs, %and10_lhs, %and10_rhs, %and11_lhs, %and11_rhs, %and12_lhs, %and12_rhs, %and13_lhs, %and13_rhs, %and14_lhs, %and14_rhs, %and15_lhs, %and15_rhs, %or0_lhs, %or0_rhs, %or1_lhs, %or1_rhs, %or2_lhs, %or2_rhs, %or3_lhs, %or3_rhs, %or4_lhs, %or4_rhs, %or5_lhs, %or5_rhs, %or6_lhs, %or6_rhs, %or7_lhs, %or7_rhs, %or8_lhs, %or8_rhs, %or9_lhs, %or9_rhs, %or10_lhs, %or10_rhs, %or11_lhs, %or11_rhs, %or12_lhs, %or12_rhs, %or13_lhs, %or13_rhs, %or14_lhs, %or14_rhs, %or15_lhs, %or15_rhs, %xor0_lhs, %xor0_rhs, %xor1_lhs, %xor1_rhs, %xor2_lhs, %xor2_rhs, %xor3_lhs, %xor3_rhs, %xor4_lhs, %xor4_rhs, %xor5_lhs, %xor5_rhs, %xor6_lhs, %xor6_rhs, %xor7_lhs, %xor7_rhs, %xor8_lhs, %xor8_rhs, %xor9_lhs, %xor9_rhs, %xor10_lhs, %xor10_rhs, %xor11_lhs, %xor11_rhs, %xor12_lhs, %xor12_rhs, %xor13_lhs, %xor13_rhs, %xor14_lhs, %xor14_rhs, %xor15_lhs, %xor15_rhs, %shift0_lhs, %shift0_rhs, %shift1_lhs, %shift1_rhs, %shift2_lhs, %shift2_rhs, %shift3_lhs, %shift3_rhs, %shift4_lhs, %shift4_rhs, %shift5_lhs, %shift5_rhs, %shift6_lhs, %shift6_rhs, %shift7_lhs, %shift7_rhs, %shift8_lhs, %shift8_rhs, %shift9_lhs, %shift9_rhs, %shift10_lhs, %shift10_rhs, %shift11_lhs, %shift11_rhs, %shift12_lhs, %shift12_rhs, %shift13_lhs, %shift13_rhs, %shift14_lhs, %shift14_rhs, %shift15_lhs, %shift15_rhs, %umin0_lhs, %umin0_rhs, %umin1_lhs, %umin1_rhs, %umin2_lhs, %umin2_rhs, %umin3_lhs, %umin3_rhs, %usub_sat0_lhs, %usub_sat0_rhs, %usub_sat1_lhs, %usub_sat1_rhs, %smin0_lhs, %smin0_rhs, %smin1_lhs, %smin1_rhs, %smin2_lhs, %smin2_rhs, %smin3_lhs, %smin3_rhs, %smin4_lhs, %smin4_rhs, %smin5_lhs, %smin5_rhs, %smin6_lhs, %smin6_rhs, %smin7_lhs, %smin7_rhs, %smin8_lhs, %smin8_rhs, %smin9_lhs, %smin9_rhs, %smax0_lhs, %smax0_rhs, %smax1_lhs, %smax1_rhs, %smax2_lhs, %smax2_rhs, %smax3_lhs, %smax3_rhs, %smax4_lhs, %smax4_rhs, %smax5_lhs, %smax5_rhs, %smax6_lhs, %smax6_rhs, %smax7_lhs, %smax7_rhs, %smax8_lhs, %smax8_rhs, %smax9_lhs, %smax9_rhs, %cmp0_lhs, %cmp0_rhs, %cmp1_lhs, %cmp1_rhs, %cmp2_lhs, %cmp2_rhs, %cmp3_lhs, %cmp3_rhs, %cmp4_lhs, %cmp4_rhs, %cmp5_lhs, %cmp5_rhs, %cmp6_lhs, %cmp6_rhs, %cmp7_lhs, %cmp7_rhs, %cmp8_lhs, %cmp8_rhs, %cmp9_lhs, %cmp9_rhs, %cmp10_lhs, %cmp10_rhs, %cmp11_lhs, %cmp11_rhs, %cmp12_lhs, %cmp12_rhs, %cmp13_lhs, %cmp13_rhs, %cmp14_lhs, %cmp14_rhs, %cmp15_lhs, %cmp15_rhs, %fp_cmp0_lhs, %fp_cmp0_rhs, %fp_cmp1_lhs, %fp_cmp1_rhs, %fp_cmp2_lhs, %fp_cmp2_rhs, %fp_cmp3_lhs, %fp_cmp3_rhs, %fp_cmp4_lhs, %fp_cmp4_rhs, %fp_cmp5_lhs, %fp_cmp5_rhs, %fp_cmp6_lhs, %fp_cmp6_rhs, %fp_cmp7_lhs, %fp_cmp7_rhs, %select0_pred, %select0_true, %select0_false, %select1_pred, %select1_true, %select1_false, %select2_pred, %select2_true, %select2_false, %select3_pred, %select3_true, %select3_false, %select4_pred, %select4_true, %select4_false, %select5_pred, %select5_true, %select5_false, %select6_pred, %select6_true, %select6_false, %select7_pred, %select7_true, %select7_false, %select8_pred, %select8_true, %select8_false, %select9_pred, %select9_true, %select9_false, %select10_pred, %select10_true, %select10_false, %select11_pred, %select11_true, %select11_false, %select12_pred, %select12_true, %select12_false, %select13_pred, %select13_true, %select13_false, %select14_pred, %select14_true, %select14_false, %select15_pred, %select15_true, %select15_false, %mux0_pred, %mux0_false, %mux0_true, %mux1_pred, %mux1_false, %mux1_true, %cast0_input, %cast1_input, %cast2_input, %cast3_input, %cast4_input, %cast5_input, %cast6_input, %cast7_input, %cast8_input, %cast9_input, %cast10_input, %cast11_input, %cast12_input, %cast13_input, %cast14_input, %cast15_input, %sext0_input, %sext1_input, %sext2_input, %sext3_input, %sext4_input, %sext5_input, %sext6_input, %sext7_input, %sext8_input, %sext9_input, %sext10_input, %sext11_input, %sext12_input, %sext13_input, %sext14_input, %sext15_input, %zext0_input, %zext1_input, %zext2_input, %zext3_input, %zext4_input, %zext5_input, %zext6_input, %zext7_input, %zext8_input, %zext9_input, %zext10_input, %zext11_input, %zext12_input, %zext13_input, %zext14_input, %zext15_input, %wide_zext0_input, %wide_zext1_input, %wide_zext2_input, %wide_zext3_input, %extui0_input, %extui1_input, %extui2_input, %extui3_input, %load_addr0, %load_addr1, %load_addr2, %load_addr3, %load_addr4, %load_addr5, %load_addr6, %load_addr7, %load_addr8, %load_addr9, %load_addr10, %load_addr11, %load_addr12, %load_addr13, %load_addr14, %load_addr15, %load_addr16, %load_addr17, %load_addr18, %load_addr19, %load_addr20, %load_addr21, %load_addr22, %load_addr23, %load_addr24, %load_addr25, %load_addr26, %load_addr27, %load_addr28, %load_addr29, %load_addr30, %load_addr31, %load_addr32, %load_addr33, %load_addr34, %load_addr35, %load_addr36, %load_addr37, %load_addr38, %load_addr39, %store_addr0, %store_value0, %store_addr1, %store_value1, %store_addr2, %store_value2, %store_addr3, %store_value3, %store_addr4, %store_value4, %store_addr5, %store_value5, %store_addr6, %store_value6, %store_addr7, %store_value7, %store_addr8, %store_value8, %store_addr9, %store_value9, %store_addr10, %store_value10, %store_addr11, %store_value11, %store_addr12, %store_value12, %store_addr13, %store_value13, %store_addr14, %store_value14, %store_addr15, %store_value15, %store_addr16, %store_value16, %store_addr17, %store_value17, %store_addr18, %store_value18, %store_addr19, %store_value19, %store_addr20, %store_value20, %store_addr21, %store_value21, %store_addr22, %store_value22, %store_addr23, %store_value23, %store_addr24, %store_value24, %store_addr25, %store_value25, %store_addr26, %store_value26, %store_addr27, %store_value27, %store_addr28, %store_value28, %store_addr29, %store_value29, %store_addr30, %store_value30, %store_addr31, %store_value31, %store_addr32, %store_value32, %store_addr33, %store_value33, %store_addr34, %store_value34, %store_addr35, %store_value35, %store_addr36, %store_value36, %store_addr37, %store_value37, %store_addr38, %store_value38, %store_addr39, %store_value39, %wide_route_bridge0_input, %wide_route_bridge1_input =
      fabric.switch [spatial] %i32a, %i32b, %i32c, %i32d, %const0, %const1, %const2, %const3, %const4, %const5, %const6, %const7, %const8, %const9, %const10, %const11, %const12, %const13, %const14, %const15, %const16, %const17, %const18, %const19, %const20, %const21, %const22, %const23, %const24, %const25, %const26, %const27, %const28, %const29, %const30, %const31, %const32, %const33, %const34, %const35, %const36, %const37, %const38, %const39, %const40, %const41, %const42, %const43, %const44, %const45, %const46, %const47, %stream0_idx, %stream0_rwc, %stream1_idx, %stream1_rwc, %stream2_idx, %stream2_rwc, %stream3_idx, %stream3_rwc, %carry0, %carry1, %carry2, %carry3, %carry4, %carry5, %carry6, %carry7, %carry8, %carry9, %carry10, %carry11, %carry12, %carry13, %carry14, %carry15, %carry16, %carry17, %carry18, %carry19, %carry20, %carry21, %carry22, %carry23, %carry24, %carry25, %carry26, %carry27, %gate0_cond, %gate0_value, %gate1_cond, %gate1_value, %gate2_cond, %gate2_value, %gate3_cond, %gate3_value, %gate4_cond, %gate4_value, %gate5_cond, %gate5_value, %gate6_cond, %gate6_value, %gate7_cond, %gate7_value, %gate8_cond, %gate8_value, %gate9_cond, %gate9_value, %gate10_cond, %gate10_value, %gate11_cond, %gate11_value, %gate12_cond, %gate12_value, %gate13_cond, %gate13_value, %gate14_cond, %gate14_value, %gate15_cond, %gate15_value, %gate16_cond, %gate16_value, %gate17_cond, %gate17_value, %gate18_cond, %gate18_value, %gate19_cond, %gate19_value, %gate20_cond, %gate20_value, %gate21_cond, %gate21_value, %gate22_cond, %gate22_value, %gate23_cond, %gate23_value, %gate24_cond, %gate24_value, %gate25_cond, %gate25_value, %gate26_cond, %gate26_value, %gate27_cond, %gate27_value, %invariant0, %invariant1, %invariant2, %invariant3, %invariant4, %invariant5, %invariant6, %invariant7, %invariant8, %invariant9, %invariant10, %invariant11, %add0, %add1, %add2, %add3, %add4, %add5, %add6, %add7, %add8, %add9, %add10, %add11, %add12, %add13, %add14, %add15, %add16, %add17, %add18, %add19, %add20, %add21, %add22, %add23, %add24, %add25, %add26, %add27, %add28, %add29, %add30, %add31, %mul0, %mul1, %mul2, %mul3, %mul4, %mul5, %mul6, %mul7, %mul8, %mul9, %mul10, %mul11, %mul12, %mul13, %mul14, %mul15, %div0, %div1, %div2, %div3, %fp_add0, %fp_add1, %fp_add2, %fp_add3, %fp_add4, %fp_add5, %fp_add6, %fp_add7, %fp_add8, %fp_add9, %fp_add10, %fp_add11, %fp_add12, %fp_add13, %fp_add14, %fp_add15, %fp_add16, %fp_add17, %fp_add18, %fp_add19, %fp_add20, %fp_add21, %fp_add22, %fp_add23, %fp_add24, %fp_add25, %fp_add26, %fp_add27, %fp_add28, %fp_add29, %fp_add30, %fp_add31, %fp_add32, %fp_add33, %fp_add34, %fp_add35, %fp_add36, %fp_add37, %fp_add38, %fp_add39, %fp_add40, %fp_add41, %fp_add42, %fp_add43, %fp_add44, %fp_add45, %fp_add46, %fp_add47, %fp_add48, %fp_add49, %fp_add50, %fp_add51, %fp_add52, %fp_add53, %fp_add54, %fp_add55, %fp_add56, %fp_add57, %fp_add58, %fp_add59, %fp_add60, %fp_add61, %fp_add62, %fp_add63, %fp_add64, %fp_add65, %fp_add66, %fp_add67, %fp_add68, %fp_add69, %fp_add70, %fp_add71, %fp_mul0, %fp_mul1, %fp_mul2, %fp_mul3, %fp_mul4, %fp_mul5, %fp_mul6, %fp_mul7, %fp_mul8, %fp_mul9, %fp_mul10, %fp_mul11, %fp_mul12, %fp_mul13, %fp_mul14, %fp_mul15, %fp_mul16, %fp_mul17, %fp_mul18, %fp_mul19, %fp_mul20, %fp_mul21, %fp_mul22, %fp_mul23, %fp_div0, %fp_div1, %fp_div2, %fp_div3, %fneg0, %fneg1, %fneg2, %fneg3, %fabs0, %fabs1, %sqrt0, %sqrt1, %exp0, %exp1, %exp2, %exp3, %cos0, %cos1, %cos2, %cos3, %sitofp0, %sitofp1, %uitofp0, %uitofp1, %uitofp2, %uitofp3, %fptosi0, %fptosi1, %fptoui0, %fptoui1, %fma0, %fma1, %fma2, %fma3, %fma4, %fma5, %fma6, %fma7, %and0, %and1, %and2, %and3, %and4, %and5, %and6, %and7, %and8, %and9, %and10, %and11, %and12, %and13, %and14, %and15, %or0, %or1, %or2, %or3, %or4, %or5, %or6, %or7, %or8, %or9, %or10, %or11, %or12, %or13, %or14, %or15, %xor0, %xor1, %xor2, %xor3, %xor4, %xor5, %xor6, %xor7, %xor8, %xor9, %xor10, %xor11, %xor12, %xor13, %xor14, %xor15, %shift0, %shift1, %shift2, %shift3, %shift4, %shift5, %shift6, %shift7, %shift8, %shift9, %shift10, %shift11, %shift12, %shift13, %shift14, %shift15, %umin0, %umin1, %umin2, %umin3, %usub_sat0, %usub_sat1, %smin0, %smin1, %smin2, %smin3, %smin4, %smin5, %smin6, %smin7, %smin8, %smin9, %smax0, %smax1, %smax2, %smax3, %smax4, %smax5, %smax6, %smax7, %smax8, %smax9, %cmp0, %cmp1, %cmp2, %cmp3, %cmp4, %cmp5, %cmp6, %cmp7, %cmp8, %cmp9, %cmp10, %cmp11, %cmp12, %cmp13, %cmp14, %cmp15, %wide_cmp0_pred, %wide_cmp1_pred, %fp_cmp0, %fp_cmp1, %fp_cmp2, %fp_cmp3, %fp_cmp4, %fp_cmp5, %fp_cmp6, %fp_cmp7, %select0, %select1, %select2, %select3, %select4, %select5, %select6, %select7, %select8, %select9, %select10, %select11, %select12, %select13, %select14, %select15, %mux0, %mux1, %cast0, %cast1, %cast2, %cast3, %cast4, %cast5, %cast6, %cast7, %cast8, %cast9, %cast10, %cast11, %cast12, %cast13, %cast14, %cast15, %sext0, %sext1, %sext2, %sext3, %sext4, %sext5, %sext6, %sext7, %sext8, %sext9, %sext10, %sext11, %sext12, %sext13, %sext14, %sext15, %zext0, %zext1, %zext2, %zext3, %zext4, %zext5, %zext6, %zext7, %zext8, %zext9, %zext10, %zext11, %zext12, %zext13, %zext14, %zext15, %wide_trunc0, %wide_trunc1, %wide_trunc2, %wide_trunc3, %wide_trunci0, %wide_trunci1, %wide_index_cast0, %wide_index_cast1, %wide_index_cast2, %wide_index_cast3, %wide_index_castui0, %wide_index_castui1, %extui0, %extui1, %extui2, %extui3, %data0, %data1, %data2, %data3, %data4, %data5, %data6, %data7, %data8, %data9, %data10, %data11, %data12, %data13, %data14, %data15, %data16, %data17, %data18, %data19, %data20, %data21, %data22, %data23, %data24, %data25, %data26, %data27, %data28, %data29, %data30, %data31, %data32, %data33, %data34, %data35, %data36, %data37, %data38, %data39
        [{connectivity_table = ["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""]}]
        : (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>)
        -> (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>)
  ...
  %wide_add0_lhs, %wide_add0_rhs, %wide_add1_lhs, %wide_add1_rhs, %wide_cmp0_lhs, %wide_cmp0_rhs, %wide_cmp1_lhs, %wide_cmp1_rhs, %wide_trunc0_input, %wide_trunc1_input, %wide_trunc2_input, %wide_trunc3_input, %wide_trunci0_input, %wide_trunci1_input, %wide_index_cast0_input, %wide_index_cast1_input, %wide_index_cast2_input, %wide_index_cast3_input, %wide_index_castui0_input, %wide_index_castui1_input =
      fabric.switch [spatial] %i64a, %i64b, %i64c, %i64d, %wide_const0, %wide_const1, %wide_const2, %wide_add0, %wide_add1, %wide_zext0, %wide_zext1, %wide_zext2, %wide_zext3, %wide_route_bridge0, %wide_route_bridge1
        [{connectivity_table = ["111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111", "111111111111111"]}]
  ...
  %const0_ctrl, %const1_ctrl, %const2_ctrl, %const3_ctrl, %const4_ctrl, %const5_ctrl, %const6_ctrl, %const7_ctrl, %const8_ctrl, %const9_ctrl, %const10_ctrl, %const11_ctrl, %const12_ctrl, %const13_ctrl, %const14_ctrl, %const15_ctrl, %const16_ctrl, %const17_ctrl, %const18_ctrl, %const19_ctrl, %const20_ctrl, %const21_ctrl, %const22_ctrl, %const23_ctrl, %const24_ctrl, %const25_ctrl, %const26_ctrl, %const27_ctrl, %const28_ctrl, %const29_ctrl, %const30_ctrl, %const31_ctrl, %const32_ctrl, %const33_ctrl, %const34_ctrl, %const35_ctrl, %const36_ctrl, %const37_ctrl, %const38_ctrl, %const39_ctrl, %const40_ctrl, %const41_ctrl, %const42_ctrl, %const43_ctrl, %const44_ctrl, %const45_ctrl, %const46_ctrl, %const47_ctrl, %wide_const0_ctrl, %wide_const1_ctrl, %wide_const2_ctrl, %sync0_in0, %sync0_in1, %sync0_in2, %sync0_in3, %sync0_in4, %sync0_in5, %sync0_in6, %sync0_in7, %sync0_in8, %sync0_in9, %sync0_in10, %sync0_in11, %sync0_in12, %sync0_in13, %sync0_in14, %sync0_in15, %sync0_in16, %sync0_in17, %sync0_in18, %sync0_in19, %sync1_in0, %sync1_in1, %sync1_in2, %sync1_in3, %sync1_in4, %sync1_in5, %sync1_in6, %sync1_in7, %sync1_in8, %sync1_in9, %sync1_in10, %sync1_in11, %sync1_in12, %sync1_in13, %sync1_in14, %sync1_in15, %sync1_in16, %sync1_in17, %sync1_in18, %sync1_in19, %sync2_in0, %sync2_in1, %sync2_in2, %sync2_in3, %sync2_in4, %sync2_in5, %sync2_in6, %sync2_in7, %sync2_in8, %sync2_in9, %sync2_in10, %sync2_in11, %sync2_in12, %sync2_in13, %sync2_in14, %sync2_in15, %sync2_in16, %sync2_in17, %sync2_in18, %sync2_in19, %sync3_in0, %sync3_in1, %sync3_in2, %sync3_in3, %sync3_in4, %sync3_in5, %sync3_in6, %sync3_in7, %sync3_in8, %sync3_in9, %sync3_in10, %sync3_in11, %sync3_in12, %sync3_in13, %sync3_in14, %sync3_in15, %sync3_in16, %sync3_in17, %sync3_in18, %sync3_in19, %load_ctrl0, %load_ctrl1, %load_ctrl2, %load_ctrl3, %load_ctrl4, %load_ctrl5, %load_ctrl6, %load_ctrl7, %load_ctrl8, %load_ctrl9, %load_ctrl10, %load_ctrl11, %load_ctrl12, %load_ctrl13, %load_ctrl14, %load_ctrl15, %load_ctrl16, %load_ctrl17, %load_ctrl18, %load_ctrl19, %load_ctrl20, %load_ctrl21, %load_ctrl22, %load_ctrl23, %load_ctrl24, %load_ctrl25, %load_ctrl26, %load_ctrl27, %load_ctrl28, %load_ctrl29, %load_ctrl30, %load_ctrl31, %load_ctrl32, %load_ctrl33, %load_ctrl34, %load_ctrl35, %load_ctrl36, %load_ctrl37, %load_ctrl38, %load_ctrl39, %store_ctrl0, %store_ctrl1, %store_ctrl2, %store_ctrl3, %store_ctrl4, %store_ctrl5, %store_ctrl6, %store_ctrl7, %store_ctrl8, %store_ctrl9, %store_ctrl10, %store_ctrl11, %store_ctrl12, %store_ctrl13, %store_ctrl14, %store_ctrl15, %store_ctrl16, %store_ctrl17, %store_ctrl18, %store_ctrl19, %store_ctrl20, %store_ctrl21, %store_ctrl22, %store_ctrl23, %store_ctrl24, %store_ctrl25, %store_ctrl26, %store_ctrl27, %store_ctrl28, %store_ctrl29, %store_ctrl30, %store_ctrl31, %store_ctrl32, %store_ctrl33, %store_ctrl34, %store_ctrl35, %store_ctrl36, %store_ctrl37, %store_ctrl38, %store_ctrl39 =
      fabric.switch [spatial] %ctrl, %sync0_done0, %sync0_done1, %sync0_done2, %sync0_done3, %sync0_done4, %sync0_done5, %sync0_done6, %sync0_done7, %sync0_done8, %sync0_done9, %sync0_done10, %sync0_done11, %sync0_done12, %sync0_done13, %sync0_done14, %sync0_done15, %sync0_done16, %sync0_done17, %sync0_done18, %sync0_done19, %sync1_done0, %sync1_done1, %sync1_done2, %sync1_done3, %sync1_done4, %sync1_done5, %sync1_done6, %sync1_done7, %sync1_done8, %sync1_done9, %sync1_done10, %sync1_done11, %sync1_done12, %sync1_done13, %sync1_done14, %sync1_done15, %sync1_done16, %sync1_done17, %sync1_done18, %sync1_done19, %sync2_done0, %sync2_done1, %sync2_done2, %sync2_done3, %sync2_done4, %sync2_done5, %sync2_done6, %sync2_done7, %sync2_done8, %sync2_done9, %sync2_done10, %sync2_done11, %sync2_done12, %sync2_done13, %sync2_done14, %sync2_done15, %sync2_done16, %sync2_done17, %sync2_done18, %sync2_done19, %sync3_done0, %sync3_done1, %sync3_done2, %sync3_done3, %sync3_done4, %sync3_done5, %sync3_done6, %sync3_done7, %sync3_done8, %sync3_done9, %sync3_done10, %sync3_done11, %sync3_done12, %sync3_done13, %sync3_done14, %sync3_done15, %sync3_done16, %sync3_done17, %sync3_done18, %sync3_done19, %done0, %done1, %done2, %done3, %done4, %done5, %done6, %done7, %done8, %done9, %done10, %done11, %done12, %done13, %done14, %done15, %done16, %done17, %done18, %done19, %done20, %done21, %done22, %done23, %done24, %done25, %done26, %done27, %done28, %done29, %done30, %done31, %done32, %done33, %done34, %done35, %done36, %done37, %done38, %done39, %store_done0, %store_done1, %store_done2, %store_done3, %store_done4, %store_done5, %store_done6, %store_done7, %store_done8, %store_done9, %store_done10, %store_done11, %store_done12, %store_done13, %store_done14, %store_done15, %store_done16, %store_done17, %store_done18, %store_done19, %store_done20, %store_done21, %store_done22, %store_done23, %store_done24, %store_done25, %store_done26, %store_done27, %store_done28, %store_done29, %store_done30, %store_done31, %store_done32, %store_done33, %store_done34, %store_done35, %store_done36, %store_done37, %store_done38, %store_done39
        ...
        -> (!fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>, !fabric.bits<0>)
