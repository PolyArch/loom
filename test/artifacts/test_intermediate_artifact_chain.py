...
def main() -> int:
    ...
    with artifact_test_common.repo_temp_dir(repo, "loom-artifact-chain-") as tmp:
        ...
        if (
            ...
            or vecsum_rows[0]["cgra_sim_cycles"] != "595"
        ...
        if comparison.get("dfg_sim_cycles") != 579 or comparison.get("cgra_sim_cycles") != 595:
        ...
        expected_dse = {
            ...
            "cgra_sim_cycles": "595",
            "frequency_mhz": "240.000",
            "area_um2": "7500.000",
            "dynamic_power_mw": "6.200",
            "leakage_power_mw": "0.850",
            "energy_nj": "17.478",
