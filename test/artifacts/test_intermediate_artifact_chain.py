...
def main() -> int:
    ...
    with artifact_test_common.repo_temp_dir(repo, "loom-artifact-chain-") as tmp:
        ...
        if (
            vecsum_rows[0]["dfg_sim_cycles"] != "649"
            or vecsum_rows[0]["cgra_sim_cycles"] != "683"
        ...
        if comparison.get("dfg_sim_cycles") != 649 or comparison.get("cgra_sim_cycles") != 683:
        ...
        expected_dse = {
            ...
            "area_um2": "60750.000",
            "dynamic_power_mw": "48.800",
            "leakage_power_mw": "6.175",
            "energy_nj": "750.958",
