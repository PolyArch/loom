    ...
    with artifact_test_common.repo_temp_dir(repo, f"loom-{case_name}-chain-") as tmp:
        ...
        assert_fields(
            mapping,
            {
                ...
                "routed_edges": expected.get(
                    "routed_edges",
                    expected["route_edge_count"] if mapping_passes else "0",
                ),
                "unrouted_edges": expected.get(
                    "unrouted_edges",
                    "0" if mapping_passes else expected["route_edge_count"],
                ),
                "unplaced_records": "0",
        ...
        existing_dfg_cycles = {448, 579, 1219}
