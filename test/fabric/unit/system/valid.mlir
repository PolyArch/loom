...
// CHECK: fabric.link src = @host0 src_port = "mem" src_channel = "aw" dst = @dram0 dst_port = "host" dst_channel = "aw"
fabric.system @heterogeneous_dual_accel_soc memory_model = "sequential" {
  ...
  fabric.link src = @host0 src_port = "mem" src_channel = "w" dst = @dram0 dst_port = "host" dst_channel = "w"
  fabric.link src = @dram0 src_port = "host" src_channel = "b" dst = @host0 dst_port = "mem" dst_channel = "b"
  fabric.link src = @host0 src_port = "mem" src_channel = "ar" dst = @dram0 dst_port = "host" dst_channel = "ar"
  fabric.link src = @dram0 src_port = "host" src_channel = "r" dst = @host0 dst_port = "mem" dst_channel = "r"
