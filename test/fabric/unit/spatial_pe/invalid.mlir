...
fabric.module @pe_mixed_input_widths {
  %a = builtin.unrealized_conversion_cast to !fabric.bits<32>
...
fabric.module @pe_input_output_width_mismatch {
  %a = builtin.unrealized_conversion_cast to !fabric.bits<32>
  // expected-error @+1 {{requires uniform 'bits<W>' on all PE ports}}
...
fabric.module @pe_inner_fu_too_many_outputs {
  %a = builtin.unrealized_conversion_cast to !fabric.bits<32>
  %r = fabric.spatial_pe(%pa = %a : !fabric.bits<32>) -> !fabric.bits<32> {
...
fabric.module @pe_inner_fu_input_width_mismatch {
  %a = builtin.unrealized_conversion_cast to !fabric.bits<32>
  %b = builtin.unrealized_conversion_cast to !fabric.bits<16>
  %r = fabric.spatial_pe(%pa = %a : !fabric.bits<32>) -> !fabric.bits<32> {
...
fabric.module @pe_inner_fu_output_width_mismatch {
  %a = builtin.unrealized_conversion_cast to !fabric.bits<32>
  %r = fabric.spatial_pe(%pa = %a : !fabric.bits<32>) -> !fabric.bits<32> {
    // expected-error @+1 {{inner fabric.fu boundary width must equal spatial_pe width W=32}}
