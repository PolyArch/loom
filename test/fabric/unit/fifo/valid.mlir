...
fabric.module @fifo_hw_not_bypassable {
...
fabric.module @fifo_hw_bypassable {
...
fabric.module @fifo_programmed_not_bypassed {
  %a = builtin.unrealized_conversion_cast to !fabric.bits<8>
...
fabric.module @fifo_programmed_bypassed {
...
fabric.module @fifo_bits_tag {
  %a = builtin.unrealized_conversion_cast to !fabric.bits_tag<8, 2>
...
fabric.module @fifo_tag {
  %a = builtin.unrealized_conversion_cast to !fabric.tag<3>
