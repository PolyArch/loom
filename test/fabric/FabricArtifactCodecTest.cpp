...
void appendSemanticDomain(std::vector<std::uint8_t> &bytes) {
  static constexpr char domain[] = "loom.fabric.semantic.v7\0";
...
void priorMajorEnvelopeIsRejected() {
  ...
  const llvm::StringRef currentDomain = "loom.fabric.semantic.v7";
...
void envelopeFramesRootDependencyAndPayloadExactly() {
  ...
  require(__func__,
          llvm::toHex(encoded.bytes(), true) ==
              "6c6f6f6d2e6661627269632e73656d616e7469632e763700"
              "00000000"
              "0000000000000001"
              "00000000"
