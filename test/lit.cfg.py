...
llvm_config.with_system_environment(
    ["HOME", "INCLUDE", "LIB", "TMP", "TEMP", "TMPDIR",
     ...
     "CDS_LIC_FILE", "CDS_LICENSE_DIR", "CDS_INST_DIR", "XCELIUM_HOME",
     "XRUN_HOME",
...
tools = [
    ...
    "loom-fabric-queue-discipline-test",
    ...
    "loom-simulator-cgra-transport-virtual-channel-test",
    "loom-simulator-cgra-closed-wait-certificate-test",
    ...
    "loom-system-channel-applicability-test",
...
config.substitutions.insert(
    0,
    (
        "%loom-runtime-dynamic-work-test\\b",
        os.path.join(
            config.loom_obj_root,
            "test",
            "runtime",
            "loom-runtime-dynamic-work-test",
        ),
    ),
)
config.substitutions.insert(
