...
// RUN: echo '{"schema_version":1,"kind":"cgra_sim_report","workload":"toy","runtime_input_identity":"toy::input","status":"pass","metric_definition":"mapping_constraint_estimate","hardware_aware_cycles":3,"performance_delta_cycles":0,"final_memory_state":{}}' > %t.no_outputs.cgra.json
...
// RUN: echo '{"schema_version":1,"kind":"cgra_sim_report","workload":"toy","runtime_input_identity":"toy::input","status":"pass","metric_definition":"mapping_constraint_estimate","hardware_aware_cycles":3,"performance_delta_cycles":0,"final_outputs":[]}' > %t.no_memory.cgra.json
