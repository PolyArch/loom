...
// RUN: loom-dfg-sim %t.lowered.mlir --graph structured_while_pointer_min --arg 0=0 --arg 1=3 --arg 2=1 --memref 3=3,-4,7 --memref 4=2,-5,9 --memref 5=0,0,0 --output %t.min.json
