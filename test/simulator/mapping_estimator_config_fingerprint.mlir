// RUN: echo '{"schema_version":"1.0","kind":"pnr_mapping","workload":"toy","hardware":"toy_adg","graph":"toy_graph","mapping_id":"toy__toy_adg","status":"pass","placed_records":0,"unplaced_records":0,"routed_edges":0,"unrouted_edges":0,"config_records":0,"placements":[],"routes":[],"config_bitstream":[]}' > %t.missing.json
