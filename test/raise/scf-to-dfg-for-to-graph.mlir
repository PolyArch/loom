...
// STREAM-ATTRS-NOT: scf.
// STREAM-ATTRS: dataflow.stream
// STREAM-ATTRS-SAME: step add while slt
...
// CHECK: dataflow.load
// CHECK: dataflow.graph.return
// CHECK-LABEL: dataflow.graph private @g_t_straight_0
// CHECK-NOT: scf.
// CHECK: dataflow.graph.return
