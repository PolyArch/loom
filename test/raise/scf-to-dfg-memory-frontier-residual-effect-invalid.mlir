...
// CHECK-LABEL: dataflow.graph private @residual_store
// CHECK: llvm.load
// CHECK-NOT: dataflow.load
dataflow.graph private @residual_store(
...
dataflow.graph private @residual_volatile_load(
    %start: none, %base: !llvm.ptr) -> (i32)
