...
// N8: coverage[0] funcname=potential_extra_n8 matched=false index=none
// N8-NEXT: all_covered=false

// N9: coverage[0] funcname=potential_extra_n9 matched=false index=none
// N9-NEXT: all_covered=false

//--- n8.mlir
fabric.module @potential_extra_n8_hardware(%a: !fabric.bits<32>) {
          ...
          fabric.op [@dataflow.sync]
            ...
            paired_lanes = [
              ...
              (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
               !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
               !fabric.bits<32>, !fabric.bits<32>)
      %single = fabric.op [@dataflow.sync] (%x) {
        hw_params = [{
          op = @dataflow.sync,
...
func.func @potential_extra_n8(%a: i32)
  ...
  %s0, %s1, %s2, %s3, %s4, %s5, %s6, %s7 =
      ...
      (i32, i32, i32, i32, i32, i32, i32, i32) ->
      (i32, i32, i32, i32, i32, i32, i32, i32)
  %single = dataflow.sync %a : (i32) -> (i32)
  %used = arith.addi %single, %single : i32
  return %s0, %s1, %s2, %s3, %s4, %s5, %s6, %s7, %used :
      i32, i32, i32, i32, i32, i32, i32, i32, i32
}

//--- n9.mlir
fabric.module @potential_extra_n9_hardware(%a: !fabric.bits<32>) {
  fabric.pe [spatial] (%pa = %a : !fabric.bits<32>)
      -> (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
...
func.func @potential_extra_n9(%a: i32)
  ...
  %single = dataflow.sync %a : (i32) -> (i32)
  %used = arith.addi %single, %single : i32
  return %s0, %s1, %s2, %s3, %s4, %s5, %s6, %s7, %s8, %used :
      i32, i32, i32, i32, i32, i32, i32, i32, i32, i32
}
