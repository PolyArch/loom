...
// N8: coverage[0] funcname=order_forced_extra_n8 matched=false index=none
// N8-NEXT: all_covered=false

// N9: coverage[0] funcname=order_forced_extra_n9 matched=false index=none
// N9-NEXT: all_covered=false

//--- n8.mlir
fabric.module @order_forced_extra_n8_hardware(%a: !fabric.bits<32>) {
  fabric.pe [spatial] (%pa = %a : !fabric.bits<32>)
    ...
    %r:12 = fabric.fu(%x = %pa : !fabric.bits<32>)
      ...
      %used0 = fabric.op [@arith.addi] (%single0, %single0) {hw_params = [{
      ...
      %used1 = fabric.op [@arith.addi] (%single1, %single1) {hw_params = [{
        op = @arith.addi, function_type = (i32, i32) -> i32,
        input_ports = [0 : i32, 1 : i32], output_ports = [0 : i32],
        attributes = {overflowFlags = #arith.overflow<none>}
      }]} : (!fabric.bits<32>, !fabric.bits<32>) -> !fabric.bits<32>
      fabric.yield %s0, %s1, %s2, %s3, %s4, %s5, %s6, %s7,
          %single0, %used0, %single1, %used1 :
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>
...
func.func @order_forced_extra_n8(%a: i32)
  ...
  %used0 = arith.addi %single0, %single0 : i32
  %single1 = dataflow.sync %a : (i32) -> (i32)
  %used1 = arith.addi %single1, %single1 : i32
  return %s0, %s1, %s2, %s3, %s4, %s5, %s6, %s7, %used0, %used1 :
      i32, i32, i32, i32, i32, i32, i32, i32, i32, i32
}

//--- n9.mlir
fabric.module @order_forced_extra_n9_hardware(%a: !fabric.bits<32>) {
  fabric.pe [spatial] (%pa = %a : !fabric.bits<32>)
      -> (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
          !fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>,
...
func.func @order_forced_extra_n9(%a: i32)
  ...
  %single1 = dataflow.sync %a : (i32) -> (i32)
  %used1 = arith.addi %single1, %single1 : i32
  return %s0, %s1, %s2, %s3, %s4, %s5, %s6, %s7, %s8, %used0, %used1 :
      i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32
}
