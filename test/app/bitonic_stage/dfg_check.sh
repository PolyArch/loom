...
grep -E -q 'dataflow\.graph\.func (private )?@g_bitonic_stage_0\(' "${DFG}"
require_graph_body_op "${DFG}" "g_bitonic_stage_0" "dataflow.load "
require_graph_body_op "${DFG}" "g_bitonic_stage_0" "dataflow.store "
require_graph_body_op "${DFG}" "g_bitonic_stage_0" "arith.cmpf "
require_graph_body_op "${DFG}" "g_bitonic_stage_0" "arith.select "
require_graph_body_op "${DFG}" "g_bitonic_stage_0" "arith.shli "
