#!/usr/bin/env bash
# Lower stream_nested from .scf.mlir into DFG MLIR via loom-lower.
...
EXPECT_GRAPH="yes"
EXPECT_GRAPH_SYMBOL_MAIN_FUNC="g_t_stream_nested_kernel_red_0_0"
EXPECT_STREAM="no"
EXPECT_LOAD="yes"
EXPECT_STORE="no"
...
require_kernel_graph "main_func" "stream_nested_kernel"
...
require_graph_body_op "main_func" "${EXPECT_GRAPH_SYMBOL_MAIN_FUNC}" "arith.shli " "arith.shli"
