#!/usr/bin/env bash
# Lower breadth_first_search and record that its kernel graph is partial.
...
REPO="$(cd "${HERE}/../../.." && pwd)"
SHARED="${REPO}/test/app/dfg_partial_lowering_common.sh"
...
partial_lowering_one "main_func" "cpp" "breadth_first_search_kernel"
