// Depthwise convolution function variant.
...
void depthwise_conv_kernel(const float *input, const float *kernel,
...
int main() {
    ...
    depthwise_conv_kernel(input.data(), kernel.data(), actual.data(), kOutputCount);
