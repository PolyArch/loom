#!/usr/bin/env bash
# Lower modexp from .scf.mlir into DFG MLIR via loom-lower.
...
KERNEL="modexp"
EXPECT_GRAPH="yes"
EXPECT_GRAPH_SYMBOL_MAIN_FUNC="g_t_modexp_kernel_0_0"
EXPECT_STREAM="no"
EXPECT_LOAD="yes"
EXPECT_STORE="yes"
...
require_kernel_graph "main_func" "modexp_kernel"
