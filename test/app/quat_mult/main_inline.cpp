...
int main() {
    ...
    for (uint32_t i = 0; i < kCount; ++i) {
        ...
        candidate[i * 4u + 0u] = w1 * w2 - x1 * x2 - y1 * y2 - z1 * z2;
        candidate[i * 4u + 1u] = w1 * x2 + x1 * w2 + y1 * z2 - z1 * y2;
        candidate[i * 4u + 2u] = w1 * y2 - x1 * z2 + y1 * w2 + z1 * x2;
        candidate[i * 4u + 3u] = w1 * z2 + x1 * y2 - y1 * x2 + z1 * w2;
    }
