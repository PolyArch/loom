#!/usr/bin/env bash
# Lower histogram_strided and record its primary graph absence.
...
REPO="$(cd "${HERE}/../../.." && pwd)"
SHARED="${REPO}/test/app/dfg_primary_absence_common.sh"
...
primary_absence_one "main_func" "cpp" "histogram_strided_kernel"
