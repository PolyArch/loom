// Image-to-column layout transform function variant.
...
void im2col_kernel(const float *input, float *output,
...
int main() {
    std::array<float, kRows * kCols> candidate = {};

    im2col_kernel(kInput.data(), candidate.data(), kChannels, kHeight, kWidth,
