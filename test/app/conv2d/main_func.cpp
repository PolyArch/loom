...
int main() {
    std::array<float, kOutputChannels * kOutH * kOutW> candidate = {};

    conv2d_kernel(kInput.data(), kKernel.data(), candidate.data(),
                  kInputChannels, kOutputChannels, kHeight, kWidth,
