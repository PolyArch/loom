#!/usr/bin/env bash
# Lower jacobi_stencil_5pt into dataflow graph MLIR and check the kernel body.
...
EXPECT_LOAD="no"
EXPECT_STORE="yes"
EXPECT_GRAPH_SYMBOL_MAIN_FUNC="g_t_jacobi_stencil_5pt_kernel_0_0"
...
require_graph_body_op "main_func" "${EXPECT_GRAPH_SYMBOL_MAIN_FUNC}" "arith.addf " "arith.addf"
require_graph_body_op "main_func" "${EXPECT_GRAPH_SYMBOL_MAIN_FUNC}" "arith.mulf " "arith.mulf"
