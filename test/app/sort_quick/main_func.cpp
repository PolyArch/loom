// Iterative quick-sort function variant migrated from the legacy app corpus.
...
void sort_quick_kernel(const float *input, float *output, uint32_t size) {
...
int main() {
    ...
    sort_quick_kernel(kInput.data(), candidate.data(), kSize);
