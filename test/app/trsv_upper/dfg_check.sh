#!/usr/bin/env bash
# Lower trsv_upper from .scf.mlir into DFG MLIR via loom-lower.
...
KERNEL="trsv_upper"
EXPECT_GRAPH="yes"
EXPECT_GRAPH_SYMBOL_MAIN_FUNC="g_t_trsv_upper_kernel_red_0_0"
...
require_kernel_graph "main_func" "trsv_upper_kernel"
