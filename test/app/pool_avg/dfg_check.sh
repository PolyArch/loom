#!/usr/bin/env bash
# Lower pool_avg into dataflow graph MLIR and check the kernel body.
...
EXPECT_LOAD="yes"
EXPECT_STORE="no"
EXPECT_GRAPH_SYMBOL_MAIN_FUNC="g_t_pool_avg_kernel_0_0"
...
require_kernel_graph "main_func" "pool_avg_kernel"
