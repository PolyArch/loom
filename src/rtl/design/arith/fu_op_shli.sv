// fu_op_shli.sv -- Left shift FU operation.
//
// Combinational: result = a << b[$clog2(WIDTH)-1:0].
// Shift amount is masked to the legal range for WIDTH.
// Intrinsic latency: 0.
...
module fu_op_shli #(
  ...
  // Number of bits needed to encode the maximum shift amount.
