// fu_op_addf.sv -- Floating-point addition FU operation.
//
...
`else
  ...
  // Replace with technology-specific FP adder IP.
  ...
  // TODO: Instantiate vendor FP add IP here.
