// fu_op_divui.sv -- Unsigned integer division FU operation.
//
// Multi-cycle iterative divider using restoring division.
// result = a / b (unsigned), or 0 when b == 0.
// Intrinsic latency: WIDTH+2 cycles.
//
// Protocol: Captures operands when idle and both inputs valid.
// Computes over WIDTH cycles. Result available with out_valid.
// Returns to idle on output transfer.
