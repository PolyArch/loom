#ifndef __DEV_LOOM_LOOMCGRADEVICE_HH__
#define __DEV_LOOM_LOOMCGRADEVICE_HH__

#include "dev/dma_device.hh"
#include "loom/Simulator/SimRuntime.h"
#include "params/LoomCgraDevice.hh"
...
class LoomCgraDevice : public DmaDevice
{
  public:
    using Params = LoomCgraDeviceParams;

    explicit LoomCgraDevice(const Params &p);
  ...
  private:
    ...
    struct PendingKernelTransfer {
        loom::sim::MemoryRequestRecord request;
        unsigned slot = 0;
        Addr physAddr = 0;
    ...
    std::unique_ptr<loom::sim::RuntimeImage> runtimeImage;
    std::unique_ptr<loom::sim::CycleKernel> kernel;
...
#endif // __DEV_LOOM_LOOMCGRADEVICE_HH__
