#ifndef __DEV_LOOM_DMA_SPIKE_DEVICE_HH__
#define __DEV_LOOM_DMA_SPIKE_DEVICE_HH__

#include <vector>

#include "base/addr_range.hh"
#include "dev/dma_device.hh"
#include "params/LoomDmaSpikeDevice.hh"
#include "sim/eventq.hh"

namespace gem5
{

class LoomDmaSpikeDevice : public DmaDevice
{
  public:
    PARAMS(LoomDmaSpikeDevice);
    explicit LoomDmaSpikeDevice(const Params &p);
...
#endif // __DEV_LOOM_DMA_SPIKE_DEVICE_HH__
