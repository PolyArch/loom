#ifndef LOOM_FABRIC_ARTIFACT_FABRICFUCAPABILITYTEMPLATE_H
#define LOOM_FABRIC_ARTIFACT_FABRICFUCAPABILITYTEMPLATE_H
...
#endif // LOOM_FABRIC_ARTIFACT_FABRICFUCAPABILITYTEMPLATE_H
