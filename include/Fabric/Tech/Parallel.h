#ifndef LOOM_FABRIC_TECH_PARALLEL_H
#define LOOM_FABRIC_TECH_PARALLEL_H

// Thin deterministic wrapper over llvm::ThreadPool.
//
...
//     scratch state; mutation of shared state must be serialized by callers.
...
#endif // LOOM_FABRIC_TECH_PARALLEL_H
