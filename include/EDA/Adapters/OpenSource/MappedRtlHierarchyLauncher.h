...
/// launcher removes the harness token from child argument files and places
/// the exact preamble token before module inputs in every argument file. It
/// never reads SystemVerilog or edits a Verilator-generated file in place.
///
...
/// executable and bundle-relative harness and preamble paths as make
/// command-line variables, which GNU make exports to the launcher's
/// environment.
...
inline constexpr llvm::StringLiteral mappedRtlHierarchyPreambleVariable =
    "LOOM_MAPPED_RTL_HIERARCHY_PREAMBLE";
...
inline constexpr llvm::StringLiteral verilatorHierarchicalChildOption =
    "--hierarchical-child";
/// Suffix appended to a Verilator-generated argument file name to form
/// the immutable filtered sibling that the launcher hands to Verilator.
inline constexpr llvm::StringLiteral mappedRtlHierarchyArgumentsSuffix =
    ".loom-hierarchy.f";
...
enum class MappedRtlHierarchyLauncherExit : int {
  ...
  Configuration = 44,
  /// An argument file did not contain the preamble token exactly once.
  PreambleTokenCount = 45,
};
