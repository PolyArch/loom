#ifndef LOOM_SIMULATOR_SIMSESSION_H
#define LOOM_SIMULATOR_SIMSESSION_H
...
private:
  ...
  std::vector<loom::ConfigGen::ConfigSlice> configSlices_;
...
#endif // LOOM_SIMULATOR_SIMSESSION_H
