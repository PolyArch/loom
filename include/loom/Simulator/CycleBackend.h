#ifndef LOOM_SIMULATOR_CYCLEBACKEND_H
#define LOOM_SIMULATOR_CYCLEBACKEND_H
...
public:
  ...
  std::string loadConfig(
      ...
      llvm::ArrayRef<loom::ConfigGen::ConfigSlice> configSlices) override;
...
#endif // LOOM_SIMULATOR_CYCLEBACKEND_H
