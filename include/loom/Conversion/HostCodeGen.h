#ifndef LOOM_CONVERSION_HOSTCODEGEN_H
#define LOOM_CONVERSION_HOSTCODEGEN_H
...
// - a host C file that replaces accelerated calls with loom_accel_* MMIO calls
// - loom_accel.h with the runtime-facing API declarations
// - loom_accel.c with the thin MMIO runtime implementation
//
