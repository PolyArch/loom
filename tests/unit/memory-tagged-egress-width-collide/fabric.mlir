module {
  ...
  fabric.module @memory_tagged_egress_width_collide_test(
    ...
    %ld_data_tag = fabric.map_tag %mem0#0
        [table_size = 2 : i64] attributes {table = [1 : i64, 9 : i64]}
        : !fabric.tagged<!fabric.bits<32>, i4>
          -> !fabric.tagged<!fabric.bits<32>, i4>
    %ld_done_tag = fabric.map_tag %mem0#1
        [table_size = 2 : i64] attributes {table = [1 : i64, 9 : i64]}
        : !fabric.tagged<none, i4>
          -> !fabric.tagged<none, i4>
