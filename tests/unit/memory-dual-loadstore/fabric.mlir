// One hardware on-chip memory with ldCount=2 and stCount=2.
module {
  fabric.temporal_sw @ld_addr_mux
  ...
  fabric.module @memory_dual_loadstore_test(
    ...
    %tsw_ld_addr:1 = fabric.instance @ld_addr_mux(%tag_ld_addr0, %tag_ld_addr1)
        {sym_name = "tsw_0"}
        : (!fabric.tagged<!fabric.bits<57>, i1>,
           !fabric.tagged<!fabric.bits<57>, i1>)
          -> (!fabric.tagged<!fabric.bits<57>, i1>)
    ...
    %mem0:3 = fabric.memory @mem_0
        ...
        (%tsw_ld_addr#0, %tsw_st_addr#0, %tsw_st_data#0)
        : (!fabric.tagged<!fabric.bits<57>, i1>,
           !fabric.tagged<!fabric.bits<57>, i1>,
           !fabric.tagged<!fabric.bits<32>, i1>)
          -> (!fabric.tagged<!fabric.bits<32>, i1>,
