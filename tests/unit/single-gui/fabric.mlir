module {
  ...
  fabric.module @single_pe_test(%in0: !fabric.bits<32>, %in1: !fabric.bits<32>, %in2: !fabric.bits<32>) -> (!fabric.bits<32>, !fabric.bits<32>) {
    %pe:2 = fabric.instance @test_pe(%in0, %in1, %in2) {sym_name = "pe_0"} : (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>) -> (!fabric.bits<32>, !fabric.bits<32>)
