module {
  fabric.temporal_pe @tpe_missing(
  ...
  fabric.module @temporal_pe_buffer_size_missing_test(%a: i32, %b: i32, %c: i32) -> (i32) {
    ...
    %tc = fabric.add_tag %c {tag = 0 : i64}
        : i32 -> !fabric.tagged<!fabric.bits<32>, i1>
    %tout = fabric.instance @tpe_missing(%ta, %tb, %tc) {sym_name = "tpe_0"}
        : (!fabric.tagged<!fabric.bits<32>, i1>,
           !fabric.tagged<!fabric.bits<32>, i1>,
           !fabric.tagged<!fabric.bits<32>, i1>)
          -> (!fabric.tagged<!fabric.bits<32>, i1>)
