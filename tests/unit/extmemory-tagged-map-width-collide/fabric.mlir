module {
  fabric.spatial_sw @ld_addr_mux
      ...
      : (!fabric.tagged<!fabric.bits<57>, i4>,
         !fabric.tagged<!fabric.bits<57>, i4>)
        -> (!fabric.tagged<!fabric.bits<57>, i3>)
  ...
  fabric.module @extmemory_tagged_map_width_collapse_test(
      %dram: memref<?xi32>,
    ...
    %ext0:2 = fabric.extmemory @extmem_0
        ...
        (%dram, %sw_ld_addr#0)
        : (memref<?xi32>, !fabric.tagged<!fabric.bits<57>, i3>)
          -> (!fabric.tagged<!fabric.bits<32>, i3>,
              !fabric.tagged<none, i3>)
