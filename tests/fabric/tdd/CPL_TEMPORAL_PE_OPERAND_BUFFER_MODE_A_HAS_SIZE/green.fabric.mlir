...
fabric.temporal_pe @tpe_per_inst_buf(%in: !dataflow.tagged<!dataflow.bits<32>, i4>)
...
fabric.module @test(%a: !dataflow.tagged<!dataflow.bits<32>, i4>) -> (!dataflow.tagged<!dataflow.bits<32>, i4>) {
  %out = fabric.instance @tpe_per_inst_buf(%a) : (!dataflow.tagged<!dataflow.bits<32>, i4>) -> (!dataflow.tagged<!dataflow.bits<32>, i4>)
