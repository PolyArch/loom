...
// XFAIL: *
// CHECK: COMP_TEMPORAL_PE_SRC_MISMATCH

// Source position mismatch: in(1) at operand position 0, in(0) at operand
// position 1. Per spec, in(j) at position i requires j == i.
// NOTE: The verifier does not yet implement COMP_TEMPORAL_PE_SRC_MISMATCH
// validation. This test is marked XFAIL until the check is added.
fabric.temporal_pe @tpe_bad(%in0: !dataflow.tagged<i32, i4>, %in1: !dataflow.tagged<i32, i4>) -> (!dataflow.tagged<i32, i4>)
