...
fabric.module @addr_translation(%stdata: !dataflow.bits<32>, %staddr: !dataflow.bits<57>, %ldaddr: !dataflow.bits<57>) -> (!dataflow.bits<32>, none, none) {
  %lddata, %lddone, %stdone = fabric.memory
      ...
      : memref<256xi32>, (!dataflow.bits<32>, !dataflow.bits<57>, !dataflow.bits<57>) -> (!dataflow.bits<32>, none, none)
