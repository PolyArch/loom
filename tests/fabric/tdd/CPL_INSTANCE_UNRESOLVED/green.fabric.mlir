...
fabric.module @adder(%a: !dataflow.bits<32>, %b: !dataflow.bits<32>) -> (!dataflow.bits<32>) {
...
fabric.module @top(%p: !dataflow.bits<32>, %q: !dataflow.bits<32>) -> (!dataflow.bits<32>) {
  %out = fabric.instance @adder(%p, %q) : (!dataflow.bits<32>, !dataflow.bits<32>) -> (!dataflow.bits<32>)
