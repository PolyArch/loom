...
fabric.temporal_sw @bad_named_tsw [num_route_table = 4]
  : (!dataflow.tagged<i32, i4>, !dataflow.tagged<i32, i4>) -> (!dataflow.tagged<i16, i4>, !dataflow.tagged<i16, i4>)
...
fabric.module @test_named_tsw_mismatch(
  ...
  %o0, %o1 = fabric.temporal_sw [num_route_table = 4]
    %a, %a : !dataflow.tagged<i32, i4> -> !dataflow.tagged<i32, i4>, !dataflow.tagged<i32, i4>
