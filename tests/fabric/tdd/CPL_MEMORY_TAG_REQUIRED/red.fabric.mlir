...
fabric.module @missing_tag(%ld_addr: !dataflow.bits<57>) -> (!dataflow.bits<32>, none) {
  %ld_data, %ld_done = fabric.memory
      [ldCount = 2, stCount = 0]
      (%ld_addr)
      : memref<64xi32>, (!dataflow.bits<57>) -> (!dataflow.bits<32>, none)
  fabric.yield %ld_data, %ld_done : !dataflow.bits<32>, none
}
