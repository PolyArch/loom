...
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.ident = "clang version 23.0.0git (https://github.com/llvm/llvm-project.git b7c1a6f8b447fba6fff47d309eb7ba1bc22e8c53)", llvm.module_asm = [], llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  handshake.func @_Z11dotprod_dsaPKfS0_i_esi(%arg0: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram9>[#loc6]), %arg1: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram9>[#loc6]), %arg2: i32 loc(fused<#di_subprogram9>[#loc6]), %arg3: i1 loc(fused<#di_subprogram9>[#loc6]), ...) -> (f32, i1) attributes {argNames = ["a", "b", "n", "start_token"], loom.annotations = ["loom.target=temporal", "loom.accel=dotprod"], resNames = ["result", "done_token"]} {
    ...
    %dataResult_0, %addressResults_1 = handshake.load [%afterValue] %19#0, %29 : index, f32 loc(#loc92)
    ...
    %dataResult_11, %addressResults_12 = handshake.load [%afterValue_5] %16#0, %24 : index, f32 loc(#loc93)
    ...
    %dataResult_15, %addressResults_16 = handshake.load [%2] %17#0, %17#1 : index, f32 loc(#loc68)
    %16:3 = handshake.memory[ld = 1, st = 1] (%dataResult_2, %addressResult, %addressResults_12) {id = 0 : i32, lsq = false} : memref<1024xf32>, (f32, index, index) -> (f32, none, none) loc(#loc2)
    %17:3 = handshake.memory[ld = 1, st = 1] (%dataResult_13, %addressResult_14, %addressResults_16) {id = 1 : i32, lsq = false} : memref<1xf32>, (f32, index, index) -> (f32, none, none) loc(#loc2)
    %18:2 = handshake.extmemory[ld = 1, st = 0] (%arg0 : memref<?xf32, strided<[1], offset: ?>>) (%addressResults) {id = 2 : i32} : (index) -> (f32, none) loc(#loc66)
    %19:2 = handshake.extmemory[ld = 1, st = 0] (%arg1 : memref<?xf32, strided<[1], offset: ?>>) (%addressResults_1) {id = 3 : i32} : (index) -> (f32, none) loc(#loc66)
    ...
    %trueResult_19, %falseResult_20 = handshake.cond_br %willContinue, %16#1 : none loc(#loc79)
    ...
    %trueResult_23, %falseResult_24 = handshake.cond_br %willContinue_4, %16#2 : none loc(#loc78)
    ...
    %trueResult_25, %falseResult_26 = handshake.cond_br %willContinue, %19#1 : none loc(#loc79)
    %30 = handshake.mux %14 [%falseResult, %falseResult_26] : index, none loc(#loc79)
    %31 = handshake.join %21, %28, %30, %17#2 : none, none, none, none loc(#loc66)
  ...
  handshake.func @_Z11dotprod_dsaPKfS0_i(%arg0: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram9>[#loc6]), %arg1: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram9>[#loc6]), %arg2: i32 loc(fused<#di_subprogram9>[#loc6]), %arg3: none loc(fused<#di_subprogram9>[#loc6]), ...) -> (f32, none) attributes {argNames = ["a", "b", "n", "start_token"], loom.annotations = ["loom.target=temporal", "loom.accel=dotprod"], resNames = ["result", "done_token"]} {
    ...
    %dataResult_0, %addressResults_1 = handshake.load [%afterValue] %18#0, %28 : index, f32 loc(#loc92)
    ...
    %dataResult_11, %addressResults_12 = handshake.load [%afterValue_5] %15#0, %23 : index, f32 loc(#loc93)
    ...
    %dataResult_15, %addressResults_16 = handshake.load [%1] %16#0, %16#1 : index, f32 loc(#loc68)
    %15:3 = handshake.memory[ld = 1, st = 1] (%dataResult_2, %addressResult, %addressResults_12) {id = 0 : i32, lsq = false} : memref<1024xf32>, (f32, index, index) -> (f32, none, none) loc(#loc2)
    %16:3 = handshake.memory[ld = 1, st = 1] (%dataResult_13, %addressResult_14, %addressResults_16) {id = 1 : i32, lsq = false} : memref<1xf32>, (f32, index, index) -> (f32, none, none) loc(#loc2)
    %17:2 = handshake.extmemory[ld = 1, st = 0] (%arg0 : memref<?xf32, strided<[1], offset: ?>>) (%addressResults) {id = 2 : i32} : (index) -> (f32, none) loc(#loc66)
    %18:2 = handshake.extmemory[ld = 1, st = 0] (%arg1 : memref<?xf32, strided<[1], offset: ?>>) (%addressResults_1) {id = 3 : i32} : (index) -> (f32, none) loc(#loc66)
    ...
    %trueResult_19, %falseResult_20 = handshake.cond_br %willContinue, %15#1 : none loc(#loc79)
    ...
    %trueResult_23, %falseResult_24 = handshake.cond_br %willContinue_4, %15#2 : none loc(#loc78)
    ...
    %trueResult_25, %falseResult_26 = handshake.cond_br %willContinue, %18#1 : none loc(#loc79)
    %29 = handshake.mux %13 [%falseResult, %falseResult_26] : index, none loc(#loc79)
    %30 = handshake.join %20, %27, %29, %16#2 : none, none, none, none loc(#loc66)
  ...
  handshake.func @_Z13vecmul_kernelPKfS0_Pfi(%arg0: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram11>[#loc13]), %arg1: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram11>[#loc13]), %arg2: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram11>[#loc13]), %arg3: i32 loc(fused<#di_subprogram11>[#loc13]), %arg4: none loc(fused<#di_subprogram11>[#loc13]), ...) -> none attributes {argNames = ["a", "b", "products", "n", "start_token"], loom.annotations = ["loom.target=temporal", "loom.accel=vecmul"], resNames = ["done_token"]} {
    ...
    %afterValue, %afterCond = dataflow.gate %index, %willContinue : index, i1 -> index, i1 loc(#loc79)
    %dataResult, %addressResults = handshake.load [%afterValue] %8#0, %11 : index, f32 loc(#loc92)
    %dataResult_0, %addressResults_1 = handshake.load [%afterValue] %9#0, %18 : index, f32 loc(#loc92)
    ...
    %8:2 = handshake.extmemory[ld = 1, st = 0] (%arg0 : memref<?xf32, strided<[1], offset: ?>>) (%addressResults) {id = 0 : i32} : (index) -> (f32, none) loc(#loc69)
    %9:2 = handshake.extmemory[ld = 1, st = 0] (%arg1 : memref<?xf32, strided<[1], offset: ?>>) (%addressResults_1) {id = 1 : i32} : (index) -> (f32, none) loc(#loc69)
    ...
    %trueResult_3, %falseResult_4 = handshake.cond_br %willContinue, %8#1 : none loc(#loc79)
    ...
    %trueResult_7, %falseResult_8 = handshake.cond_br %willContinue, %9#1 : none loc(#loc79)
