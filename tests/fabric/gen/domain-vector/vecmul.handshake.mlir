...
#di_file = #llvm.di_file<"tests/app/vecmul/main.cpp" in "/home/sihao/github.com/PolyArch/loom">
#di_file3 = #llvm.di_file<"tests/app/vecmul/vecmul.cpp" in "/home/sihao/github.com/PolyArch/loom">
...
#loc12 = loc("tests/app/vecmul/main.cpp":25:0)
#loc15 = loc("tests/app/vecmul/main.cpp":31:0)
#loc19 = loc("tests/app/vecmul/main.cpp":37:0)
#loc22 = loc("tests/app/vecmul/main.cpp":44:0)
#loc33 = loc("tests/app/vecmul/vecmul.cpp":19:0)
#loc37 = loc("tests/app/vecmul/vecmul.cpp":11:0)
#loc38 = loc("tests/app/vecmul/vecmul.cpp":12:0)
...
#di_subprogram5 = #llvm.di_subprogram<recId = distinct[2]<>, id = distinct[5]<>, compileUnit = #di_compile_unit1, scope = #di_file3, name = "vecmul_cpu", linkageName = "_Z10vecmul_cpuPKfS0_Pfi", file = #di_file3, line = 11, scopeLine = 11, subprogramFlags = "Definition|Optimized", type = #di_subroutine_type2, retainedNodes = #di_local_variable17, #di_local_variable18, #di_local_variable14, #di_local_variable3, #di_local_variable15>
...
#di_subprogram8 = #llvm.di_subprogram<recId = distinct[1]<>, id = distinct[7]<>, compileUnit = #di_compile_unit1, scope = #di_file3, name = "vecmul_dsa", linkageName = "_Z10vecmul_dsaPKfS0_Pfi", file = #di_file3, line = 19, scopeLine = 20, subprogramFlags = "Definition|Optimized", type = #di_subroutine_type4, retainedNodes = #di_local_variable20, #di_local_variable21, #di_local_variable16, #di_local_variable2, #di_local_variable13>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.ident = "clang version 23.0.0git (https://github.com/llvm/llvm-project.git b7c1a6f8b447fba6fff47d309eb7ba1bc22e8c53)", llvm.module_asm = [], llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  memref.global constant @".str.7" : memref<14xi8> = dense<[99, 32, 61, 32, 97, 32, 42, 32, 98, 32, 61, 32, 91, 0]> {alignment = 1 : i64} loc(#loc)
  ...
  memref.global constant @str : memref<31xi8> = dense<[86, 101, 99, 116, 111, 114, 32, 77, 117, 108, 116, 105, 112, 108, 105, 99, 97, 116, 105, 111, 110, 32, 82, 101, 115, 117, 108, 116, 115, 58, 0]> {alignment = 1 : i64} loc(#loc)
  ...
  memref.global constant @".str.1.18" : memref<28xi8> = dense<[116, 101, 115, 116, 115, 47, 97, 112, 112, 47, 118, 101, 99, 109, 117, 108, 47, 118, 101, 99, 109, 117, 108, 46, 99, 112, 112, 0]> loc(#loc)
  ...
  func.func @main() -> i32 {
    ...
    %3 = memref.get_global @str : memref<31xi8> loc(#loc2)
    ...
    call @_Z10vecmul_cpuPKfS0_Pfi(%cast, %cast_4, %cast_5, %c8_i32) : (memref<?xf32, strided<[1], offset: ?>>, memref<?xf32, strided<[1], offset: ?>>, memref<?xf32, strided<[1], offset: ?>>, i32) -> () loc(#loc49)
    ...
    %14 = handshake.esi_instance @_Z10vecmul_dsaPKfS0_Pfi_esi "_Z10vecmul_dsaPKfS0_Pfi_inst0" clk %0 rst %false(%chanOutput, %chanOutput_7, %chanOutput_9, %chanOutput_11, %chanOutput_13) : (!esi.channel<memref<?xf32, strided<[1], offset: ?>>>, !esi.channel<memref<?xf32, strided<[1], offset: ?>>>, !esi.channel<memref<?xf32, strided<[1], offset: ?>>>, !esi.channel<i32>, !esi.channel<i1>) -> !esi.channel<i1> loc(#loc50)
    %rawOutput, %valid = esi.unwrap.vr %14, %true : i1 loc(#loc50)
    %intptr = memref.extract_aligned_pointer_as_index %3 : memref<31xi8> -> index loc(#loc51)
    ...
    %37:2 = scf.while (%arg0 = %c0_i64, %arg1 = %c1_i8) : (i64, i8) -> (i64, i8) {
      ...
      %48 = arith.mulf %46, %47 : f32 loc(#loc84)
  ...
  handshake.func @_Z10vecmul_dsaPKfS0_Pfi_esi(%arg0: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram8>[#loc33]), %arg1: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram8>[#loc33]), %arg2: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram8>[#loc33]), %arg3: i32 loc(fused<#di_subprogram8>[#loc33]), %arg4: i1 loc(fused<#di_subprogram8>[#loc33]), ...) -> i1 attributes {argNames = ["a", "b", "c", "n", "start_token"], loom.annotations = ["loom.accel"], resNames = ["done_token"]} {
    ...
    %index, %willContinue = dataflow.stream %6, %5, %7 {loom.annotations = ["loom.loop.parallel degree=4 schedule=1", "loom.loop.tripcount typical=256 avg=256 min=1 max=1024"], step_op = "+=", stop_cond = "!="} loc(#loc69)
    ...
    %8 = arith.mulf %dataResult, %dataResult_0 : f32 loc(#loc86)
  ...
  handshake.func @_Z10vecmul_dsaPKfS0_Pfi(%arg0: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram8>[#loc33]), %arg1: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram8>[#loc33]), %arg2: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram8>[#loc33]), %arg3: i32 loc(fused<#di_subprogram8>[#loc33]), %arg4: none loc(fused<#di_subprogram8>[#loc33]), ...) -> none attributes {argNames = ["a", "b", "c", "n", "start_token"], loom.annotations = ["loom.accel"], resNames = ["done_token"]} {
    ...
    %index, %willContinue = dataflow.stream %5, %4, %6 {loom.annotations = ["loom.loop.parallel degree=4 schedule=1", "loom.loop.tripcount typical=256 avg=256 min=1 max=1024"], step_op = "+=", stop_cond = "!="} loc(#loc69)
    %afterValue, %afterCond = dataflow.gate %index, %willContinue : index, i1 -> index, i1 loc(#loc69)
    ...
    %7 = arith.mulf %dataResult, %dataResult_0 : f32 loc(#loc86)
  ...
  func.func @_Z10vecmul_cpuPKfS0_Pfi(%arg0: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc37]), %arg1: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc37]), %arg2: memref<?xf32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc37]), %arg3: i32 loc(fused<#di_subprogram5>[#loc37])) {
    ...
    scf.if %0 {
      ...
      %2 = scf.while (%arg4 = %c0_i64) : (i64) -> i64 {
        ...
        %6 = arith.mulf %4, %5 : f32 loc(#loc76)
...
#loc = loc("tests/app/vecmul/main.cpp":0:0)
#loc1 = loc("tests/app/vecmul/main.cpp":11:0)
#loc2 = loc(unknown)
#loc3 = loc("tests/app/vecmul/main.cpp":13:0)
#loc4 = loc("tests/app/vecmul/main.cpp":14:0)
#loc5 = loc("tests/app/vecmul/main.cpp":15:0)
#loc6 = loc("tests/app/vecmul/main.cpp":16:0)
#loc7 = loc("tests/app/vecmul/main.cpp":19:0)
#loc8 = loc("tests/app/vecmul/main.cpp":20:0)
#loc9 = loc("tests/app/vecmul/main.cpp":23:0)
#loc10 = loc("tests/app/vecmul/main.cpp":24:0)
#loc11 = loc("tests/app/vecmul/main.cpp":26:0)
#loc13 = loc("tests/app/vecmul/main.cpp":28:0)
#loc14 = loc("tests/app/vecmul/main.cpp":30:0)
#loc16 = loc("tests/app/vecmul/main.cpp":32:0)
#loc17 = loc("tests/app/vecmul/main.cpp":34:0)
#loc18 = loc("tests/app/vecmul/main.cpp":36:0)
#loc20 = loc("tests/app/vecmul/main.cpp":38:0)
#loc21 = loc("tests/app/vecmul/main.cpp":40:0)
#loc23 = loc("tests/app/vecmul/main.cpp":45:0)
#loc24 = loc("tests/app/vecmul/main.cpp":46:0)
#loc25 = loc("/usr/lib/gcc/x86_64-redhat-linux/14/../../../../include/c++/14/cmath":239:0)
#loc26 = loc("tests/app/vecmul/main.cpp":47:0)
#loc27 = loc("tests/app/vecmul/main.cpp":49:0)
#loc28 = loc("tests/app/vecmul/main.cpp":48:0)
#loc29 = loc("tests/app/vecmul/main.cpp":51:0)
#loc30 = loc("tests/app/vecmul/main.cpp":54:0)
#loc31 = loc("tests/app/vecmul/main.cpp":61:0)
#loc32 = loc("/usr/include/stdio.h":363:0)
#loc34 = loc("tests/app/vecmul/vecmul.cpp":23:0)
#loc35 = loc("tests/app/vecmul/vecmul.cpp":24:0)
#loc36 = loc("tests/app/vecmul/vecmul.cpp":26:0)
#loc39 = loc("tests/app/vecmul/vecmul.cpp":13:0)
#loc40 = loc("tests/app/vecmul/vecmul.cpp":15:0)
