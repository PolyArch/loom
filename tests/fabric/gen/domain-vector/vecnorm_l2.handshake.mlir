...
#di_file = #llvm.di_file<"tests/app/vecnorm_l2/main.cpp" in "/home/sihao/github.com/PolyArch/loom">
#di_file1 = #llvm.di_file<"tests/app/vecnorm_l2/vecnorm_l2.cpp" in "/home/sihao/github.com/PolyArch/loom">
...
#loc3 = loc("tests/app/vecnorm_l2/main.cpp":12:0)
#loc9 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":25:0)
#loc13 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":13:0)
#loc14 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":16:0)
...
#di_lexical_block1 = #llvm.di_lexical_block<scope = #di_subprogram1, file = #di_file1, line = 30>
...
#di_local_variable3 = #llvm.di_local_variable<scope = #di_subprogram1, name = "norm_sq", file = #di_file1, line = 27, type = #di_derived_type1>
#di_local_variable4 = #llvm.di_local_variable<scope = #di_lexical_block1, name = "i", file = #di_file1, line = 30, type = #di_derived_type1>
#di_local_variable5 = #llvm.di_local_variable<scope = #di_subprogram2, name = "norm_sq", file = #di_file1, line = 15, type = #di_derived_type1>
...
#di_local_variable9 = #llvm.di_local_variable<scope = #di_subprogram1, name = "N", file = #di_file1, line = 26, arg = 2, type = #di_derived_type2>
#di_local_variable10 = #llvm.di_local_variable<scope = #di_subprogram2, name = "N", file = #di_file1, line = 14, arg = 2, type = #di_derived_type2>
...
#di_local_variable11 = #llvm.di_local_variable<scope = #di_subprogram1, name = "A", file = #di_file1, line = 25, arg = 1, type = #di_derived_type4>
#di_local_variable12 = #llvm.di_local_variable<scope = #di_subprogram2, name = "A", file = #di_file1, line = 13, arg = 1, type = #di_derived_type4>
#di_subroutine_type1 = #llvm.di_subroutine_type<types = #di_derived_type1, #di_derived_type4, #di_derived_type2>
#di_subprogram4 = #llvm.di_subprogram<recId = distinct[1]<>, id = distinct[6]<>, compileUnit = #di_compile_unit1, scope = #di_file1, name = "vecnorm_l2_dsa", linkageName = "_Z14vecnorm_l2_dsaPKjj", file = #di_file1, line = 25, scopeLine = 26, subprogramFlags = "Definition|Optimized", type = #di_subroutine_type1, retainedNodes = #di_local_variable11, #di_local_variable9, #di_local_variable3, #di_local_variable4>
#di_subprogram5 = #llvm.di_subprogram<recId = distinct[2]<>, id = distinct[7]<>, compileUnit = #di_compile_unit1, scope = #di_file1, name = "vecnorm_l2_cpu", linkageName = "_Z14vecnorm_l2_cpuPKjj", file = #di_file1, line = 13, scopeLine = 14, subprogramFlags = "Definition|Optimized", type = #di_subroutine_type1, retainedNodes = #di_local_variable12, #di_local_variable10, #di_local_variable5, #di_local_variable6>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.ident = "clang version 23.0.0git (https://github.com/llvm/llvm-project.git b7c1a6f8b447fba6fff47d309eb7ba1bc22e8c53)", llvm.module_asm = [], llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  memref.global constant @str : memref<19xi8> = dense<[118, 101, 99, 110, 111, 114, 109, 95, 108, 50, 58, 32, 80, 65, 83, 83, 69, 68, 0]> {alignment = 1 : i64} loc(#loc)
  memref.global constant @str.2 : memref<19xi8> = dense<[118, 101, 99, 110, 111, 114, 109, 95, 108, 50, 58, 32, 70, 65, 73, 76, 69, 68, 0]> {alignment = 1 : i64} loc(#loc)
  memref.global constant @".str" : memref<11xi8> = dense<[108, 111, 111, 109, 46, 97, 99, 99, 101, 108, 0]> loc(#loc)
  memref.global constant @".str.1" : memref<36xi8> = dense<[116, 101, 115, 116, 115, 47, 97, 112, 112, 47, 118, 101, 99, 110, 111, 114, 109, 95, 108, 50, 47, 118, 101, 99, 110, 111, 114, 109, 95, 108, 50, 46, 99, 112, 112, 0]> loc(#loc)
  ...
  func.func @main() -> i32 {
    ...
    %4 = call @_Z14vecnorm_l2_cpuPKjj(%cast, %c1024_i32) : (memref<?xi32, strided<[1], offset: ?>>, i32) -> i32 loc(#loc18)
    ...
    %5:2 = handshake.esi_instance @_Z14vecnorm_l2_dsaPKjj_esi "_Z14vecnorm_l2_dsaPKjj_inst0" clk %0 rst %false(%chanOutput, %chanOutput_0, %chanOutput_2) : (!esi.channel<memref<?xi32, strided<[1], offset: ?>>>, !esi.channel<i32>, !esi.channel<i1>) -> (!esi.channel<i32>, !esi.channel<i1>) loc(#loc19)
  ...
  handshake.func @_Z14vecnorm_l2_dsaPKjj_esi(%arg0: memref<?xi32, strided<[1], offset: ?>> loc(fused<#di_subprogram4>[#loc9]), %arg1: i32 loc(fused<#di_subprogram4>[#loc9]), %arg2: i1 loc(fused<#di_subprogram4>[#loc9]), ...) -> (i32, i1) attributes {argNames = ["A", "N", "start_token"], loom.annotations = ["loom.accel"], resNames = ["norm_sq", "done_token"]} {
    ...
    %8 = dataflow.carry %willContinue, %2, %10 : i1, i32, i32 -> i32 loc(#loc31)
    ...
    %dataResult, %addressResults = handshake.load [%afterValue] %15#0, %16 : index, i32 loc(#loc35)
    %9 = arith.muli %dataResult, %dataResult : i32 loc(#loc35)
    %10 = arith.addi %9, %afterValue_0 : i32 loc(#loc35)
    %11 = handshake.constant %1 {value = 0 : index} : index loc(#loc31)
    %12 = handshake.constant %1 {value = 1 : index} : index loc(#loc31)
    %13 = arith.select %4, %12, %11 : index loc(#loc31)
    %14 = handshake.mux %13 [%falseResult_3, %2] : index, i32 loc(#loc31)
    %15:2 = handshake.extmemory[ld = 1, st = 0] (%arg0 : memref<?xi32, strided<[1], offset: ?>>) (%addressResults) {id = 0 : i32} : (index) -> (i32, none) loc(#loc25)
    %16 = dataflow.carry %willContinue, %falseResult, %trueResult_4 : i1, none, none -> none loc(#loc31)
    %trueResult_4, %falseResult_5 = handshake.cond_br %willContinue, %15#1 : none loc(#loc31)
    %17 = handshake.mux %13 [%falseResult_5, %trueResult] : index, none loc(#loc31)
    %18 = handshake.constant %17 {value = true} : i1 loc(#loc25)
    handshake.return %14, %18 : i32, i1 loc(#loc25)
  } loc(#loc25)
  handshake.func @_Z14vecnorm_l2_dsaPKjj(%arg0: memref<?xi32, strided<[1], offset: ?>> loc(fused<#di_subprogram4>[#loc9]), %arg1: i32 loc(fused<#di_subprogram4>[#loc9]), %arg2: none loc(fused<#di_subprogram4>[#loc9]), ...) -> (i32, none) attributes {argNames = ["A", "N", "start_token"], loom.annotations = ["loom.accel"], resNames = ["norm_sq", "done_token"]} {
    ...
    %afterValue, %afterCond = dataflow.gate %index, %willContinue : index, i1 -> index, i1 loc(#loc31)
    %7 = dataflow.carry %willContinue, %1, %9 : i1, i32, i32 -> i32 loc(#loc31)
    ...
    %8 = arith.muli %dataResult, %dataResult : i32 loc(#loc35)
    %9 = arith.addi %8, %afterValue_0 : i32 loc(#loc35)
    %10 = handshake.constant %0 {value = 0 : index} : index loc(#loc31)
    %11 = handshake.constant %0 {value = 1 : index} : index loc(#loc31)
    %12 = arith.select %3, %11, %10 : index loc(#loc31)
    %13 = handshake.mux %12 [%falseResult_3, %1] : index, i32 loc(#loc31)
    ...
    handshake.return %13, %16 : i32, none loc(#loc26)
  } loc(#loc25)
  func.func @_Z14vecnorm_l2_cpuPKjj(%arg0: memref<?xi32, strided<[1], offset: ?>> {loom.noalias} loc(fused<#di_subprogram5>[#loc13]), %arg1: i32 loc(fused<#di_subprogram5>[#loc13])) -> i32 {
    ...
    %1 = scf.if %0 -> (i32) {
      ...
      %3:2 = scf.while (%arg2 = %c0_i64, %arg3 = %c0_i32) : (i64, i32) -> (i64, i32) {
        ...
        %6 = arith.muli %5, %5 : i32 loc(#loc36)
        %7 = arith.addi %6, %arg3 : i32 loc(#loc36)
        %8 = arith.addi %arg2, %c1_i64 : i64 loc(#loc34)
        %9 = arith.cmpi ne, %8, %2 : i64 loc(#loc37)
        scf.condition(%9) %8, %7 : i64, i32 loc(#loc32)
      } do {
...
#loc = loc("tests/app/vecnorm_l2/main.cpp":0:0)
#loc1 = loc("tests/app/vecnorm_l2/main.cpp":5:0)
#loc2 = loc(unknown)
#loc4 = loc("tests/app/vecnorm_l2/main.cpp":13:0)
#loc5 = loc("tests/app/vecnorm_l2/main.cpp":17:0)
#loc6 = loc("tests/app/vecnorm_l2/main.cpp":18:0)
#loc7 = loc("tests/app/vecnorm_l2/main.cpp":20:0)
#loc8 = loc("tests/app/vecnorm_l2/main.cpp":27:0)
#loc10 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":30:0)
#loc11 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":31:0)
#loc12 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":33:0)
#loc15 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":17:0)
#loc16 = loc("tests/app/vecnorm_l2/vecnorm_l2.cpp":19:0)
...
#di_lexical_block7 = #llvm.di_lexical_block<scope = #di_subprogram4, file = #di_file1, line = 30>
#loc24 = loc(fused<#di_lexical_block5>[#loc3])
#loc26 = loc(fused<#di_subprogram4>[#loc12])
#loc28 = loc(fused<#di_subprogram5>[#loc16])
#di_lexical_block9 = #llvm.di_lexical_block<scope = #di_lexical_block7, file = #di_file1, line = 30>
...
#di_lexical_block11 = #llvm.di_lexical_block<scope = #di_lexical_block9, file = #di_file1, line = 30>
