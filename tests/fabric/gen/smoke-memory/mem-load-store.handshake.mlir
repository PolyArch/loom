module {
  handshake.func @mem_load_store(%mem: memref<?xf32>, %idx: i32, %ctrl: none, ...) -> (f32, none)
    ...
    %0:2 = handshake.extmemory[ld = 1, st = 0] (%mem : memref<?xf32>) (%addressResults) {id = 0 : i32} : (index) -> (f32, none)
