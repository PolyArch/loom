...
#di_file = #llvm.di_file<"tests/app/ctz/ctz.cpp" in "/home/sihao/github.com/PolyArch/loom">
#di_file1 = #llvm.di_file<"tests/app/ctz/main.cpp" in "/home/sihao/github.com/PolyArch/loom">
...
#loc1 = loc("tests/app/ctz/ctz.cpp":14:0)
#loc3 = loc("tests/app/ctz/ctz.cpp":17:0)
#loc6 = loc("tests/app/ctz/ctz.cpp":25:0)
#loc10 = loc("tests/app/ctz/ctz.cpp":38:0)
#loc24 = loc("tests/app/ctz/main.cpp":16:0)
#loc28 = loc("tests/app/ctz/main.cpp":31:0)
...
#di_local_variable13 = #llvm.di_local_variable<scope = #di_subprogram1, name = "output_count", file = #di_file, line = 39, arg = 2, type = #di_derived_type5>
...
#di_local_variable17 = #llvm.di_local_variable<scope = #di_lexical_block11, name = "count", file = #di_file, line = 49, type = #di_derived_type1>
#di_subroutine_type1 = #llvm.di_subroutine_type<types = #di_null_type, #di_derived_type6, #di_derived_type5, #di_derived_type2>
#di_subprogram4 = #llvm.di_subprogram<recId = distinct[0]<>, id = distinct[6]<>, compileUnit = #di_compile_unit, scope = #di_file, name = "ctz_cpu", linkageName = "_Z7ctz_cpuPKjPjj", file = #di_file, line = 14, scopeLine = 16, subprogramFlags = "Definition|Optimized", type = #di_subroutine_type1, retainedNodes = #di_local_variable14, #di_local_variable12, #di_local_variable4, #di_local_variable, #di_local_variable5, #di_local_variable15>
#di_subprogram5 = #llvm.di_subprogram<recId = distinct[1]<>, id = distinct[7]<>, compileUnit = #di_compile_unit, scope = #di_file, name = "ctz_dsa", linkageName = "_Z7ctz_dsaPKjPjj", file = #di_file, line = 38, scopeLine = 40, subprogramFlags = "Definition|Optimized", type = #di_subroutine_type1, retainedNodes = #di_local_variable16, #di_local_variable13, #di_local_variable6, #di_local_variable1, #di_local_variable7, #di_local_variable17>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.ident = "clang version 23.0.0git (https://github.com/llvm/llvm-project.git b7c1a6f8b447fba6fff47d309eb7ba1bc22e8c53)", llvm.module_asm = [], llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  memref.global constant @".str.1" : memref<22xi8> = dense<[116, 101, 115, 116, 115, 47, 97, 112, 112, 47, 99, 116, 122, 47, 99, 116, 122, 46, 99, 112, 112, 0]> loc(#loc)
  memref.global constant @str : memref<12xi8> = dense<[99, 116, 122, 58, 32, 70, 65, 73, 76, 69, 68, 0]> {alignment = 1 : i64} loc(#loc)
  memref.global constant @str.2 : memref<12xi8> = dense<[99, 116, 122, 58, 32, 80, 65, 83, 83, 69, 68, 0]> {alignment = 1 : i64} loc(#loc)
  ...
  func.func @_Z7ctz_cpuPKjPjj(%arg0: memref<?xi32, strided<[1], offset: ?>> {loom.noalias} loc(fused<#di_subprogram4>[#loc1]), %arg1: memref<?xi32, strided<[1], offset: ?>> {loom.noalias} loc(fused<#di_subprogram4>[#loc1]), %arg2: i32 loc(fused<#di_subprogram4>[#loc1])) {
    ...
    scf.if %0 {
      ...
      %2 = scf.while (%arg3 = %c0_i64) : (i64) -> i64 {
        ...
        %6 = scf.if %5 -> (i32) {
          ...
          %9 = arith.andi %4, %c1_i32 : i32 loc(#loc69)
          %10 = arith.cmpi eq, %9, %c0_i32 : i32 loc(#loc69)
          %11 = scf.if %10 -> (i32) {
            %12:2 = scf.while (%arg4 = %c0_i32, %arg5 = %4) : (i32, i32) -> (i32, i32) {
              %13 = arith.addi %arg4, %c1_i32 : i32 loc(#loc71)
              %14 = arith.shrui %arg5, %c1_i32 : i32 loc(#loc72)
              %15 = arith.andi %arg5, %c2_i32 : i32 loc(#loc69)
              %16 = arith.cmpi eq, %15, %c0_i32 : i32 loc(#loc69)
              scf.condition(%16) %13, %14 : i32, i32 loc(#loc69)
            } do {
            ...
            scf.yield %12#0 : i32 loc(#loc69)
          } else {
            scf.yield %c0_i32 : i32 loc(#loc69)
          } loc(#loc69)
          scf.yield %11 : i32 loc(#loc65)
        } loc(#loc65)
  ...
  handshake.func @_Z7ctz_dsaPKjPjj_esi(%arg0: memref<?xi32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc10]), %arg1: memref<?xi32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc10]), %arg2: i32 loc(fused<#di_subprogram5>[#loc10]), %arg3: i1 loc(fused<#di_subprogram5>[#loc10]), ...) -> i1 attributes {argNames = ["input_data", "output_count", "N", "start_token"], loom.annotations = ["loom.accel"], resNames = ["done_token"]} {
    ...
    %6 = handshake.constant %1 {value = 2 : i32} : i32 loc(#loc2)
    %7 = arith.cmpi eq, %arg2, %3 : i32 loc(#loc58)
    %trueResult, %falseResult = handshake.cond_br %7, %1 : none loc(#loc53)
    ...
    %12 = arith.cmpi eq, %dataResult, %3 : i32 loc(#loc67)
    %trueResult_0, %falseResult_1 = handshake.cond_br %12, %11 : none loc(#loc67)
    %13 = arith.andi %dataResult, %2 : i32 loc(#loc70)
    %14 = arith.cmpi eq, %13, %3 : i32 loc(#loc70)
    %15 = handshake.constant %1 {value = true} : i1 loc(#loc70)
    %16 = dataflow.carry %15, %3, %trueResult_2 : i1, i32, i32 -> i32 loc(#loc70)
    %17 = dataflow.carry %15, %dataResult, %trueResult_4 : i1, i32, i32 -> i32 loc(#loc70)
    %18 = arith.addi %16, %2 : i32 loc(#loc73)
    %19 = arith.shrui %17, %2 : i32 loc(#loc74)
    %20 = arith.andi %17, %6 : i32 loc(#loc70)
    %21 = arith.cmpi eq, %20, %3 : i32 loc(#loc70)
    %trueResult_2, %falseResult_3 = handshake.cond_br %21, %18 : i32 loc(#loc70)
    %trueResult_4, %falseResult_5 = handshake.cond_br %21, %19 : i32 loc(#loc70)
    handshake.sink %falseResult_5 : i32 loc(#loc70)
    ...
    %25 = handshake.mux %24 [%3, %falseResult_3] : index, i32 loc(#loc70)
    %26 = handshake.constant %11 {value = 0 : index} : index loc(#loc67)
    %27 = handshake.constant %11 {value = 1 : index} : index loc(#loc67)
    %28 = arith.select %12, %27, %26 : index loc(#loc67)
    ...
    %35 = arith.select %7, %34, %33 : index loc(#loc53)
  ...
  handshake.func @_Z7ctz_dsaPKjPjj(%arg0: memref<?xi32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc10]), %arg1: memref<?xi32, strided<[1], offset: ?>> loc(fused<#di_subprogram5>[#loc10]), %arg2: i32 loc(fused<#di_subprogram5>[#loc10]), %arg3: none loc(fused<#di_subprogram5>[#loc10]), ...) -> none attributes {argNames = ["input_data", "output_count", "N", "start_token"], loom.annotations = ["loom.accel"], resNames = ["done_token"]} {
    ...
    %5 = handshake.constant %0 {value = 2 : i32} : i32 loc(#loc2)
    %6 = arith.cmpi eq, %arg2, %2 : i32 loc(#loc58)
    %trueResult, %falseResult = handshake.cond_br %6, %0 : none loc(#loc53)
    %7 = handshake.constant %falseResult {value = 1 : index} : index loc(#loc53)
    %8 = arith.index_cast %3 : i64 to index loc(#loc53)
    %9 = arith.index_cast %arg2 : i32 to index loc(#loc53)
    %index, %willContinue = dataflow.stream %8, %7, %9 {loom.annotations = ["loom.loop.parallel=auto", "loom.loop.unroll factor=8"], step_op = "+=", stop_cond = "!="} loc(#loc53)
    %afterValue, %afterCond = dataflow.gate %index, %willContinue : index, i1 -> index, i1 loc(#loc53)
    ...
    %11 = arith.cmpi eq, %dataResult, %2 : i32 loc(#loc67)
    %trueResult_0, %falseResult_1 = handshake.cond_br %11, %10 : none loc(#loc67)
    %12 = arith.andi %dataResult, %1 : i32 loc(#loc70)
    %13 = arith.cmpi eq, %12, %2 : i32 loc(#loc70)
    %14 = handshake.constant %0 {value = true} : i1 loc(#loc70)
    %15 = dataflow.carry %14, %2, %trueResult_2 : i1, i32, i32 -> i32 loc(#loc70)
    %16 = dataflow.carry %14, %dataResult, %trueResult_4 : i1, i32, i32 -> i32 loc(#loc70)
    %17 = arith.addi %15, %1 : i32 loc(#loc73)
    %18 = arith.shrui %16, %1 : i32 loc(#loc74)
    %19 = arith.andi %16, %5 : i32 loc(#loc70)
    %20 = arith.cmpi eq, %19, %2 : i32 loc(#loc70)
    %trueResult_2, %falseResult_3 = handshake.cond_br %20, %17 : i32 loc(#loc70)
    %trueResult_4, %falseResult_5 = handshake.cond_br %20, %18 : i32 loc(#loc70)
    handshake.sink %falseResult_5 : i32 loc(#loc70)
    ...
    %24 = handshake.mux %23 [%2, %falseResult_3] : index, i32 loc(#loc70)
    %25 = handshake.constant %10 {value = 0 : index} : index loc(#loc67)
    %26 = handshake.constant %10 {value = 1 : index} : index loc(#loc67)
    %27 = arith.select %11, %26, %25 : index loc(#loc67)
    ...
    %34 = arith.select %6, %33, %32 : index loc(#loc53)
  ...
  func.func @main() -> i32 {
    ...
    %c22136_i32 = arith.constant 22136 : i32 loc(#loc2)
    %c1_i64 = arith.constant 1 : i64 loc(#loc2)
    ...
    memref.store %c1_i32, %alloca[%c1] : memref<256xi32> loc(#loc38)
    memref.store %c2_i32, %alloca[%c2] : memref<256xi32> loc(#loc37)
    memref.store %c-2147483648_i32, %alloca[%c3] : memref<256xi32> loc(#loc36)
    ...
    %4 = scf.while (%arg0 = %c5_i64) : (i64) -> i64 {
      ...
      %12 = arith.muli %11, %c22136_i32 : i32 loc(#loc54)
    ...
    call @_Z7ctz_cpuPKjPjj(%cast, %cast_2, %c256_i32) : (memref<?xi32, strided<[1], offset: ?>>, memref<?xi32, strided<[1], offset: ?>>, i32) -> () loc(#loc40)
    ...
    %5 = handshake.esi_instance @_Z7ctz_dsaPKjPjj_esi "_Z7ctz_dsaPKjPjj_inst0" clk %0 rst %false(%chanOutput, %chanOutput_4, %chanOutput_6, %chanOutput_8) : (!esi.channel<memref<?xi32, strided<[1], offset: ?>>>, !esi.channel<memref<?xi32, strided<[1], offset: ?>>>, !esi.channel<i32>, !esi.channel<i1>) -> !esi.channel<i1> loc(#loc41)
...
#loc = loc("tests/app/ctz/ctz.cpp":0:0)
#loc2 = loc(unknown)
#loc4 = loc("tests/app/ctz/ctz.cpp":18:0)
#loc5 = loc("tests/app/ctz/ctz.cpp":20:0)
#loc7 = loc("tests/app/ctz/ctz.cpp":26:0)
#loc8 = loc("tests/app/ctz/ctz.cpp":27:0)
#loc9 = loc("tests/app/ctz/ctz.cpp":33:0)
#loc11 = loc("tests/app/ctz/ctz.cpp":43:0)
#loc12 = loc("tests/app/ctz/ctz.cpp":44:0)
#loc13 = loc("tests/app/ctz/ctz.cpp":46:0)
#loc14 = loc("tests/app/ctz/ctz.cpp":51:0)
#loc15 = loc("tests/app/ctz/ctz.cpp":52:0)
#loc16 = loc("tests/app/ctz/ctz.cpp":53:0)
#loc17 = loc("tests/app/ctz/ctz.cpp":59:0)
#loc18 = loc("tests/app/ctz/main.cpp":5:0)
#loc19 = loc("tests/app/ctz/main.cpp":14:0)
#loc20 = loc("tests/app/ctz/main.cpp":13:0)
#loc21 = loc("tests/app/ctz/main.cpp":12:0)
#loc22 = loc("tests/app/ctz/main.cpp":11:0)
#loc23 = loc("tests/app/ctz/main.cpp":10:0)
#loc25 = loc("tests/app/ctz/main.cpp":17:0)
#loc26 = loc("tests/app/ctz/main.cpp":25:0)
#loc27 = loc("tests/app/ctz/main.cpp":28:0)
#loc29 = loc("tests/app/ctz/main.cpp":32:0)
#loc30 = loc("tests/app/ctz/main.cpp":33:0)
#loc31 = loc("tests/app/ctz/main.cpp":34:0)
#loc32 = loc("tests/app/ctz/main.cpp":38:0)
#loc33 = loc("tests/app/ctz/main.cpp":40:0)
...
#di_lexical_block30 = #llvm.di_lexical_block<scope = #di_lexical_block28, file = #di_file, line = 25>
