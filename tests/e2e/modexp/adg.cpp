//===-- adg.cpp - modexp ADG generation ------------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("modexp.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "modexp ADG generator\n");
