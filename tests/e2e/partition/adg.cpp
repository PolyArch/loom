//===-- adg.cpp - partition ADG generation ---------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("partition.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "partition ADG generator\n");
  ...
  opts.moduleName = "partition_domain";
  opts.numPEs = 128;
  opts.numExtMems = 2;
