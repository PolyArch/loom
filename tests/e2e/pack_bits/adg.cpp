//===-- adg.cpp - pack_bits ADG generation ---------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("pack_bits.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "pack_bits ADG generator\n");
  ...
  opts.moduleName = "pack_bits_domain";
  opts.numPEs = 96;
  opts.numExtMems = 2;
