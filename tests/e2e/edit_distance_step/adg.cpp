//===-- adg.cpp - edit_distance_step ADG generation ------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("edit_distance_step.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "edit_distance_step ADG generator\n");
  ...
  opts.moduleName = "edit_distance_step_domain";
  opts.numPEs = 128;
  opts.numExtMems = 6;
