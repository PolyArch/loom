//===-- adg.cpp - kmp_table ADG generation ---------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("kmp_table.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "kmp_table ADG generator\n");
  ...
  opts.moduleName = "kmp_table_domain";
  opts.numPEs = 160;
  opts.numExtMems = 2;
