//===-- adg.cpp - hash_mix ADG generation ----------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("hash_mix.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "hash_mix ADG generator\n");
  ...
  opts.moduleName = "hash_mix_domain";
  opts.numPEs = 64;
  opts.numExtMems = 3;
