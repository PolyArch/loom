//===-- adg.cpp - scatter_add ADG generation -------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("scatter_add.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "scatter_add ADG generator\n");
  ...
  opts.moduleName = "scatter_add_domain";
  opts.numPEs = 160;
  opts.numExtMems = 3;
