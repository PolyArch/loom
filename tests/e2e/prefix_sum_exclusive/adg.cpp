//===-- adg.cpp - prefix_sum_exclusive ADG generation ----------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("prefix_sum_exclusive.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "prefix_sum_exclusive ADG generator\n");
  ...
  opts.moduleName = "prefix_sum_exclusive_domain";
