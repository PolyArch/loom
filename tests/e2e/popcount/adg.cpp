//===-- adg.cpp - popcount ADG generation ----------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("popcount.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "popcount ADG generator\n");
  ...
  opts.moduleName = "popcount_domain";
  opts.numPEs = 64;
  opts.numExtMems = 2;
