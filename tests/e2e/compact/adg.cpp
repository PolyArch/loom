//===-- adg.cpp - compact ADG generation -----------------------*- C++ -*-===//
...
static llvm::cl::opt<std::string> outputFile(
    ...
    llvm::cl::init("compact.fabric.mlir"));

int main(int argc, char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv, "compact ADG generator\n");
  ...
  opts.moduleName = "compact_domain";
  opts.numPEs = 96;
  opts.numExtMems = 2;
