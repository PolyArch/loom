//===- main.cpp - Vector Multiplication Test Program ----------------------===//
//
// Test program for loom compiler - compiles and runs vector multiplication.
//
//===----------------------------------------------------------------------===//
...
int main() {
  ...
  vecmul_cpu(a, b, c_cpu, N);
  vecmul_dsa(a, b, c_accel, N);
