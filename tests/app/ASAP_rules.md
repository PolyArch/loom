# ASAP Performance Modeling Rules

This document is the authoritative specification for the fully-unrolled ASAP
performance model reported in `tests/app/<kernel>/<kernel>_eval.md`. The CGRA
resource and scheduling models in
[`docs/spec-kernel-performance.md`](../../docs/spec-kernel-performance.md) build
on this dynamic-operation and dependency baseline. If this document and an
implementation or evaluation disagree, this document wins.
