...
// Test: a=[0,1,2], b=[4,5,6], fa=[1,2,4], fc=[-0.5,1.5,5], N=3
// Branch coverage: [0]=if (fa*fc<0), [1]=else, [2]=else
// Element 0: fa*fc = 1*(-0.5) = -0.5 < 0 → [a,c] = [0,2]
// Element 1: fa*fc = 2*1.5 = 3 > 0 → [c,b] = [3,5]
// Element 2: fa*fc = 4*5 = 20 > 0 → [c,b] = [4,6]
...
// Rule: if f(a)*f(c) < 0, new interval is [a,c]; else [c,b]
