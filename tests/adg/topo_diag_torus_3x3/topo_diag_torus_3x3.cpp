...
//   - Internal fifo instances for wraparound (3 EW + 3 NS + 5 SE + 5 SW = 16 fifos)
...
int main() {
  ...
  assert(mlirCount(mlir, "fabric.fifo") == 16 && "expected 16 fifo instances (3 EW + 3 NS + 5 SE + 5 SW)");
