//===-- temporal_pe_registers.cpp - ADG test: temporal PE regs -*- C++ -*-===//
//
...
int main() {
  ADGBuilder builder("temporal_pe_registers");
  ...
  auto tpe = builder.newTemporalPE("tpe_regs")
      .setNumRegisters(4)
      .setNumInstructions(8)
      .setRegFifoDepth(2)
  ...
  builder.exportMLIR("Output/temporal_pe_registers.fabric.mlir");
  return 0;
}
