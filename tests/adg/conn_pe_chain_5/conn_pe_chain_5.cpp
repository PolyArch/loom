//===-- conn_pe_chain_5.cpp - ADG test: chain of 5 PEs --------*- C++ -*-===//
//
...
int main() {
  ADGBuilder builder("conn_pe_chain_5");
  ...
  auto a4 = builder.clone(adder, "a4");
  ...
  builder.connectToModuleInput(x2, a1, 1);
  builder.connectPorts(a1, 0, a2, 0);
  builder.connectToModuleInput(x3, a2, 1);
  builder.connectPorts(a2, 0, a3, 0);
  builder.connectToModuleInput(x4, a3, 1);
  builder.connectPorts(a3, 0, a4, 0);
  builder.connectToModuleInput(x5, a4, 1);
  builder.connectToModuleOutput(a4, 0, out);

  builder.exportMLIR("Output/conn_pe_chain_5.fabric.mlir");
  return 0;
}
