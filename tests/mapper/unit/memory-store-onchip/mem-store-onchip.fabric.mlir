module {
  ...
  fabric.module @genadg_1(%arg0: none, %arg1: !dataflow.bits<32>, %arg2: !dataflow.bits<57>) -> (none) {
    %0:5 = fabric.switch [connectivity_table = ["111111", "111111", "111111", "111111", "111111"]] %1#2, %1#3, %2#0, %2#1, %arg0, %13 : none -> none, none, none, none, none
    ...
    %4:5 = fabric.switch [connectivity_table = ["11111", "11111", "11111", "11111", "11111"]] %5#2, %5#3, %6#0, %6#1, %arg1 : !dataflow.bits<32> -> !dataflow.bits<32>, !dataflow.bits<32>, !dataflow.bits<32>, !dataflow.bits<32>, !dataflow.bits<32>
    ...
    %13 = fabric.memory [ldCount = 0, stCount = 1, lsqDepth = 1, is_private = true] (%7#4, %11#4) : memref<256xi32>, (!dataflow.bits<32>, !dataflow.bits<57>) -> (none)
