module {
  ...
  fabric.module @genadg_1(%arg0: none, %arg1: !dataflow.bits<57>) -> (none, !dataflow.bits<32>) {
    %0:5 = fabric.switch [connectivity_table = ["111111", "111111", "111111", "111111", "111111"]] %1#2, %1#3, %2#0, %2#1, %arg0, %13#1 : none -> none, none, none, none, none
    ...
    %8:5 = fabric.switch [connectivity_table = ["11111", "11111", "11111", "11111", "11111"]] %9#2, %9#3, %10#0, %10#1, %arg1 : !dataflow.bits<57> -> !dataflow.bits<57>, !dataflow.bits<57>, !dataflow.bits<57>, !dataflow.bits<57>, !dataflow.bits<57>
    ...
    %13:2 = fabric.memory [ldCount = 1, stCount = 0, is_private = true] (%11#4) : memref<256xi32>, (!dataflow.bits<57>) -> (!dataflow.bits<32>, none)
