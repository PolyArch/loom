// Temporal-single-slot-xfail fabric: same as temporal-single-slot.
// 1 TPE with fu_add only, 1 instruction slot.
// DFGs requiring more than 1 slot MUST fail (capacity exceeded).
//
// 2x2 switch mesh:
//       col0        col1
// row0: ST00 ------ ST01
...
module {
  ...
  fabric.module @temporal_single_slot_xfail(
