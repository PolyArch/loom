...
module {
  fabric.extmemory @extmem_def
      ...
      : (memref<?xi32>, !fabric.bits<32>) -> (!fabric.bits<32>, !fabric.bits<32>)
  ...
  fabric.module @test_extmemory_single_load(
      %dram: memref<?xi32>, %idx: !fabric.bits<32>, %ctrl: !fabric.bits<32>)
      -> (!fabric.bits<32>, !fabric.bits<32>) {
    ...
    %pe_ld:2 = fabric.instance @load_pe(%idx, %ext0#0, %ctrl)
        ...
        : (!fabric.bits<32>, !fabric.bits<32>, !fabric.bits<32>)
          -> (!fabric.bits<32>, !fabric.bits<32>)
    fabric.yield %pe_ld#0, %ext0#1 : !fabric.bits<32>, !fabric.bits<32>
  }
}
