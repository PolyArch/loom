...
bool ConfigGen::writeConfigHeader(const std::string &path) const {
  ...
  out << "static const uint32_t loom_runtime_config_words[] = {";
  ...
  out << "};\n";
  out << "static const unsigned loom_runtime_config_word_count = "
      << configWords_.size() << ";\n";
  out << "static const int loom_runtime_config_complete = "
      << (configComplete_ ? 1 : 0) << ";\n\n";
  out << "#endif\n";
  return true;
}
