#ifndef LOOM_MAPPER_TECHMAPPER_INTERNAL_H
#define LOOM_MAPPER_TECHMAPPER_INTERNAL_H
...
void collectVariantsForFU(loom::fabric::FunctionUnitOp fuOp,
                          const Node *hwNode,
...
#endif // LOOM_MAPPER_TECHMAPPER_INTERNAL_H
