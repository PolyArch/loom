...
//
//===----------------------------------------------------------------------===//
#ifndef LOOM_SIMULATOR_FUNCTIONALBACKENDIMPL_H
#define LOOM_SIMULATOR_FUNCTIONALBACKENDIMPL_H

#include "loom/Simulator/FunctionalBackend.h"
...
#endif // LOOM_SIMULATOR_FUNCTIONALBACKENDIMPL_H
