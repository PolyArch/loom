...
SpatialBindingRelationModel::create(
  ...
  // Graph-boundary attachment domains retain their ordinary typed endpoint
  // choices. A global all-different relation would reject legal temporal or
  // causally separated reuse; actual overlapping residency remains owned by
  // route/resource capacity and the independent Mapping verifier.
