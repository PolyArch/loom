...
/// Sorted-by-value occupancy of one match domain: the tag vertices resident
/// under each Physical Tag value.
using SpatialTagDomainOccupancy =
    PhysicalTagKeyedMap<std::vector<SpatialTagVertexRef>>;
