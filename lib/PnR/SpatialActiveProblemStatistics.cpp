...
SpatialActiveProblemStatistics buildSpatialActiveProblemStatistics(
  ...
  addTrackedArray(bytes, work, handshake.fixedFragments());
  addTrackedArray(bytes, work, handshake.traversalFragmentOffsets());
  addTrackedArray(bytes, work, handshake.traversalFragments());
  addTrackedArray(bytes, work, handshake.allTraversalGroups());
  addTrackedArray(bytes, work, handshake.allTraversalGroupWitnesses());
  addTrackedArray(bytes, work, handshake.traversalAllGroupOffsets());
  addTrackedArray(bytes, work, handshake.traversalAllGroups());
  addTrackedArray(bytes, work, handshake.switchActivations());
  addTrackedArray(bytes, work, handshake.switchActivationBaseFragments());
  addTrackedArray(bytes, work, handshake.switchTraversalSelections());
  addTrackedArray(bytes, work, handshake.switchTraversalFragments());
  addTrackedArray(bytes, work, handshake.switchContentionRelations());
  addTrackedArray(bytes, work, handshake.computePlacementFragmentOffsets());
  ...
  addTrackedArray(bytes, work, handshake.memoryPlacementDomainOffsets());
  addTrackedArray(bytes, work, handshake.memoryOperationPlans());
  addTrackedArray(bytes, work, handshake.memoryPlanFragments());
  addTrackedArray(bytes, work, handshake.projectionNodeSignals());
