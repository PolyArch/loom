...
struct UpliftWhileToForPass
  ...
  StringRef getArgument() const final { return "fcc-uplift-while-to-for"; }
...
struct EliminateSubviewBumpsPass
  ...
  StringRef getArgument() const override {
    return "fcc-eliminate-subview-bumps";
  }
...
std::unique_ptr<Pass> fcc::createUpliftWhileToForPass() {
  return std::make_unique<UpliftWhileToForPass>();
}

std::unique_ptr<Pass> fcc::createEliminateSubviewBumpsPass() {
