...
fcc::fabric::detail::getFabricScalarWidth(mlir::Type type) {
...
std::optional<unsigned>
fcc::fabric::detail::getSpatialSwitchPayloadWidth(mlir::Type type) {
...
mlir::LogicalResult fcc::fabric::detail::verifyBinaryRowTable(
...
mlir::Operation *
fcc::fabric::detail::getDirectRegionParent(mlir::Operation *op) {
  if (!op)
    return nullptr;
...
mlir::ParseResult fcc::fabric::detail::parseOptionalOperandListInParens(
...
mlir::ParseResult fcc::fabric::detail::normalizeMemoryConfigAttrs(
...
void fcc::fabric::detail::printNamedAttrsWithAliases(
