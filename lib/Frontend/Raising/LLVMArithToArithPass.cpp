...
struct LLVMArithToArithPass
  ...
  void runOnOperation() final {
    ...
    patterns.add<
        ...
        UnaryFloatAlias<::mlir::LLVM::FCeilOp, ::mlir::math::CeilOp>,
        UnaryFloatAlias<::mlir::LLVM::FFloorOp, ::mlir::math::FloorOp>,
        UnaryFloatAlias<::mlir::LLVM::FTruncOp, ::mlir::math::TruncOp>,
