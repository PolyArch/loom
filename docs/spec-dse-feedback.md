...
| 13 | `application_product_oracle` | `0: loom.application.runtime_manifest 5.0`, `1: System SimulationExecution` | both forbidden; the execution Request must use the manifest's exact activation workload and runtime input |
