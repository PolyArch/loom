...
`loom.mapping.root_complete_spatial_pnr.generator.v6`; the direct constrained
Spatial provider uses `loom.mapping.spatial_pnr.generator.v6`. Both identities
select the Spatial 9.0 search semantics. It consumes the finite TechMapping
