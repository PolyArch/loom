...
`loom.fabric 7.0` owns this complete existential local-reference catalog. The
...
stable for all schema 7.x versions. New kinds append under a compatible minor
